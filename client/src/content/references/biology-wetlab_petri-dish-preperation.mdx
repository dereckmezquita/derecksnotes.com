...
- Bunsen burner
- Appropriate antibiotics</a> if necessary
...
It is important to let the medium cool before proceeding, as any antibiotics</a> which may be added at hot temperatures would simply denature and thus be rendered useless. Make sure to also annotate the dishes being used.

Once the bottle is cool enough to hold proceed to add an appropriate dose of antibiotics</a>. In this example we will be using the following antibiotics at the following concentrations:
