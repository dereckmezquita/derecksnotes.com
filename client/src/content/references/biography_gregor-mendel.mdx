...
<Figure src="/references/biography_gregor-mendel/portraitMendel.jpeg"/>
...
<Figure src="/references/biography_gregor-mendel/peasMendel.jpeg">
    Representative of the kind of Pea plants with which Mendel worked.
</Figure>
...
<Figure src="/references/biography_gregor-mendel/peasCharacteristics_page45-46_1.png">
    Excerpt from Mendel's Experiments in Plant Hybridisation[^1]<sup>,</sup> [^2].
</Figure>

<Figure src="/references/biography_gregor-mendel/peasCharacteristics_page45-46_2.png">
    Excerpt from Mendel's Experiments in Plant Hybridisation[^1]<sup>,</sup> [^2].
</Figure>
