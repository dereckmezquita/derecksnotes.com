...
<Figure src='/courses/engineering-microorganisms/centralAuxGenome.png'>
    Drawing illustrating central vs auxiliary genome between different species.
</Figure>
...
<Figure src='/courses/engineering-microorganisms/naturalSelection.svg'>
    An illustration of natural selection.
</Figure>
...
<Figure src='/courses/engineering-microorganisms/geneticDrift.svg'>
    Drawing illustrating genetic drift, sample population contains more green strains than any other, six green.
</Figure>
