...
<Figure src="/courses/introduction-to-statistics/statsNormalDist.png">
    A typical normal distribution of an arbitrary data set, with the blue line in the center representing the mean.
</Figure>
