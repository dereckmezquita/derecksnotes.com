...
<Figure src="/courses/introduction-to-statistics_files/figure-html/mean-vs-median-skewed-income-1.png" alt="Demonstrating mean and median; mean can be skewed by a few high income earners.">
	Demonstrating mean and median; mean can be skewed by a few high income earners.
</Figure>

<Alert type="note">
    As you can see by the plot, the mean is skewed by the few high income earners. The average is 41,204 while the median is 29,590 a difference of 11,614.
</Alert>
...
<Figure src="/courses/introduction-to-statistics_files/figure-html/adding-age-to-income-1.png">
