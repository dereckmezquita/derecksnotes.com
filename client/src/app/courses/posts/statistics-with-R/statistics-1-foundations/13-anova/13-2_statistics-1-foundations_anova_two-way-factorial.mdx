...
##    → Significant main effect: BMI differs across age groups.
## 
## 3. Interaction (Gender × Age):
##    F(2, 294) = 1.82, p = 0.1646
##    → No significant interaction: The effect of age on BMI
...
## =========================
## 
## Gender:       η²p = 0.0049 (0.5% of variance)
## Age Group:    η²p = 0.0546 (5.5% of variance)
## Interaction:  η²p = 0.0122 (1.2% of variance)
## 
...
## p = 0.000, η²p = 0.055. 
## 
## The Gender × Age Group interaction was not significant, F(2, 294) = 1.82,
