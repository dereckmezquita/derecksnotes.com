...
#>   Intercept (<U+2248> mean): 35.5
cat("  Slope (≈ SD):", round(slope, 2), "\n")
#>   Slope (<U+2248> SD): 26.32
...
<Figure src="/courses/statistics-1-foundations/lineplot_covid-1.png" alt="Daily COVID-19 testing volume over pandemic days">
	Daily COVID-19 testing volume over pandemic days
</Figure>
