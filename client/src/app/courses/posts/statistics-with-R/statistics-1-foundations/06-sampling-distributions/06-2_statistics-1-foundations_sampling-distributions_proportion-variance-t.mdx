...
```
##   SE(p<U+0302>) = <U+221A>[p(1-p)/n] = 0.0648
```
...
```
## Rule: np <U+2265> 10 AND n(1-p) <U+2265> 10
```
...
```
## n= 10, p=0.30: np=3, n(1-p)=7 <U+2192> <U+2717> Not adequate
## n= 30, p=0.30: np=9, n(1-p)=21 <U+2192> <U+2717> Not adequate
## n=100, p=0.30: np=30, n(1-p)=70 <U+2192> <U+2713> Adequate
## n=100, p=0.05: np=5, n(1-p)=95 <U+2192> <U+2717> Not adequate
```
...
```
## n =  5 (df = 4):
##   E(S<U+00B2>) = 100.80 (theoretical = 100)
##   Var(S<U+00B2>) = 2732.38 (theoretical = 5000.00)
## 
## n = 10 (df = 9):
##   E(S<U+00B2>) = 100.80 (theoretical = 100)
##   Var(S<U+00B2>) = 2732.38 (theoretical = 2222.22)
## 
## n = 30 (df = 29):
##   E(S<U+00B2>) = 100.80 (theoretical = 100)
##   Var(S<U+00B2>) = 2732.38 (theoretical = 689.66)
```
...
```
##   Group 1: <U+03BC><U+2081> = 120, <U+03C3><U+2081> = 15, n<U+2081> = 30
```
...
```
##   Group 2: <U+03BC><U+2082> = 115, <U+03C3><U+2082> = 12, n<U+2082> = 30
```
...
```
## Difference (X<U+0304><U+2081> - X<U+0304><U+2082>):
```
...
```
##   Theoretical mean: <U+03BC><U+2081> - <U+03BC><U+2082> = 5
```
...
```
##   Theoretical SE: <U+221A>(<U+03C3><U+2081><U+00B2>/n<U+2081> + <U+03C3><U+2082><U+00B2>/n<U+2082>) = 3.507
```
...
```
## Sampling Distribution of p<U+0302><U+2081> - p<U+0302><U+2082>
```
...
```
##   Drug A: p<U+2081> = 0.60, n<U+2081> = 100
```
...
```
##   Drug B: p<U+2082> = 0.45, n<U+2082> = 100
```
...
```
## Difference (p<U+0302><U+2081> - p<U+0302><U+2082>):
```
...
```
##   Theoretical mean: p<U+2081> - p<U+2082> = 0.15
```
...
```
##   - Approaches normal as df <U+2192> <U+221E>
```
...
```
## Critical values (two-tailed, <U+03B1> = 0.05):
```
...
```
## Testing H<U+2080>: <U+03BC> = 0 (no effect):
```
...
```
##   (using t<U+2080>.<U+2080><U+2082><U+2085>,<U+2082><U+2084> = 2.064)
```
...
```
##    Population: n = 7205, <U+03BC> = 120.7, <U+03C3> = 17.1
```
...
```
##    30% response doesn't mean the true rate is exactly 30% <U+2014> it could
```
...
```
##   'The margin of error you hear in polls (e.g., <U+00B1>3%) is the same
```
...
```
##    diminishing returns <U+2014> doubling precision requires quadrupling
```
