...
```
## Population: <U+03BC> = 10.0, <U+03C3> = 5.0
```
...
```
##   Mean of sample means: 9.87 (true <U+03BC> = 10.0)
```
...
```
##   SE = 8.05 (theoretical <U+03C3>/<U+221A>n = 8.00)
```
...
```
## n =  10: SE = 3.162 (95% of means within <U+00B1>6.20 of <U+03BC>)
## n =  40: SE = 1.581 (95% of means within <U+00B1>3.10 of <U+03BC>)
## n = 160: SE = 0.791 (95% of means within <U+00B1>1.55 of <U+03BC>)
```
...
```
## 
## Note: Quadrupling n halves the SE (due to <U+221A>n relationship)
```
...
```
## The Central Limit Theorem: Any Population <U+2192> Normal Sample Means
```
...
##   Mean = 1.992, SD = 1.984, Skewness <U+2248> 1.98
## 
## Uniform population:
##   Mean = 5.001, SD = 2.883, Skewness <U+2248> 0.00
## 
## Bimodal population:
##   Mean = 4.997, SD = 3.043, Skewness <U+2248> 0.00
## 
## Beta population:
##   Mean = 0.286, SD = 0.159, Skewness <U+2248> 0.60
```
...
```
##    find an average effect within <U+00B1>3 mmHg of the true effect.'
```
...
```
##   'One coin flip is completely unpredictable <U+2014> 50/50. But if you
```
