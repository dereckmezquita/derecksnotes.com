...
```{r t_distribution, fig.cap="The t-distribution has heavier tails than the normal"}
...
```{r t_interval_example, fig.cap="T-interval for systolic blood pressure"}
...
```{r z_vs_t_comparison, fig.cap="Z-interval underestimates uncertainty when sigma is unknown"}
set.seed(456)
...
```{r two_sample_ci, fig.cap="Confidence interval for difference in means"}
