...
```{r wald_interval, fig.cap="Wald confidence interval for proportion"}
...
```{r wald_problems, fig.cap="Wald interval can have poor coverage near boundaries"}
set.seed(123)
...
```{r two_proportion_ci, fig.cap="Confidence interval for difference in proportions"}
...
```{r chi_square_dist, fig.cap="The chi-square distribution for different degrees of freedom"}
...
```{r variance_ci_visual, fig.cap="CI for variance is asymmetric due to chi-square distribution"}
