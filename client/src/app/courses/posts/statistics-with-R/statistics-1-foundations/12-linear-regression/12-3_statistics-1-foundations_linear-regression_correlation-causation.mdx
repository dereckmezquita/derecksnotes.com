...
## 
## r = β₁ × (s_x / s_y) = 0.9225 × (10.1049 / 20.1849) = 0.4618
## Direct r = 0.4618
```
...
## spurious—it disappears when we control for temperature.
```
...
## 
## This is NOT real change—it's regression to the mean!
...
## 
## Slope: 0.01649
## R²: 0.000274 (0.0274% of variance explained)
## p-value: 0.0979
```
...
## THE NUMBERS:
## ------------
## • For every additional centimetre of height, weight increases
##   by approximately 0.9 kg on average.
## 
## • This relationship explains about 21% of the variation
##   in weight among adults.
## 
## • We are 95% confident that the true effect is between
...
## • Predictions are reliable only within the observed height range
##   (140–194 cm).
## • Individual variation is substantial; this describes averages.
```
