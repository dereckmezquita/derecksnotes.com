...
## S_xx = 50951.93
## 
## Slope (β₁) = S_xy / S_xx = 0.9225
## Intercept (β₀) = ȳ - β₁x̄ = -74.5558
```
...
## ===========================
## 
## Manual β₀: -74.5558, lm() β₀: -74.5558
## Manual β₁: 0.9225, lm() β₁: 0.9225
```
...
##   (Not meaningful here—extrapolation beyond data range)
## 
## Slope (β₁ = 0.922):
...
## 
## SE(β₁) = √(MSE/S_xx) = 0.0794
## SE(β₀) = √(MSE(1/n + x̄²/S_xx)) = 13.4287
## 
## Compare with summary(model):
##                Estimate  Std. Error
...
## p-value: 8.87e-28
## 
## Conclusion: Reject H₀. There is significant evidence of a
...
## 
## R² = SSR/SST = 43356.85/203308.43 = 0.2133
## R² = 1 - SSE/SST = 1 - 159951.58/203308.43 = 0.2133
## 
...
##   Weight = -74.56 + 0.922 × Height
## 
## Height was a significant predictor of weight (β = 0.922, 
