...
![plot of chunk scatter_plot](/courses/statistics-1-foundations/scatter_plot-1.png)
...
![plot of chunk residual_visual](/courses/statistics-1-foundations/residual_visual-1.png)
...
```
## Slope (<U+03B2><U+2081>) = S_xy / S_xx = 0.9225
```
...
```
## Intercept (<U+03B2><U+2080>) = <U+0233> - <U+03B2><U+2081>x<U+0304> = -74.5558
```
...
```
## Manual <U+03B2><U+2080>: -74.5558, lm() <U+03B2><U+2080>: -74.5558
```
...
```
## Manual <U+03B2><U+2081>: 0.9225, lm() <U+03B2><U+2081>: 0.9225
```
...
```
##   The predicted weight when height is 0 cm.
```
...
```
##   (Not meaningful here<U+2014>extrapolation beyond data range)
```
...
```
##   weight increases by 0.922 kg on average.
```
...
```
## Residual Sum of Squares (RSS) = 159951.58
```
...
```
## Mean Square Error (MSE) = 321.1879
```
...
```
## SE(<U+03B2><U+2081>) = <U+221A>(MSE/S_xx) = 0.0794
```
...
```
## SE(<U+03B2><U+2080>) = <U+221A>(MSE(1/n + x<U+0304><U+00B2>/S_xx)) = 13.4287
```
...
```
##                Estimate  Std. Error
## (Intercept) -74.5557691 13.42872011
## Height        0.9224622  0.07939612
```
...
```
## H<U+2080>: <U+03B2><U+2081> = 0 (no linear relationship)
```
...
```
## H<U+2081>: <U+03B2><U+2081> <U+2260> 0 (linear relationship exists)
```
...
```
## Test statistic: t = 0.922 / 0.0794 = 11.618
```
...
```
## Conclusion: Reject H<U+2080>. There is significant evidence of a
...
```
##   0.9225 <U+00B1> 1.965 <U+00D7> 0.0794
```
...
```
##                    2.5 %     97.5 %
## (Intercept) -100.9396990 -48.171839
## Height         0.7664696   1.078455
```
...
![plot of chunk slope_uncertainty](/courses/statistics-1-foundations/slope_uncertainty-1.png)
...
```
## Total Sum of Squares (SST) = 203308.43
```
...
```
## Regression Sum of Squares (SSR) = 43356.85
```
...
```
## Error Sum of Squares (SSE) = 159951.58
```
...
```
## R<U+00B2> = SSR/SST = 43356.85/203308.43 = 0.2133
```
...
```
## R<U+00B2> = 1 - SSE/SST = 1 - 159951.58/203308.43 = 0.2133
```
...
```
## Interpretation: Height explains 21.3% of the
```
...
```
## 
## summary(model)$r.squared: 0.2133
```
...
```
## R<U+00B2> from regression = 0.2133
```
...
![plot of chunk r_squared_visual](/courses/statistics-1-foundations/r_squared_visual-1.png)
...
```
## Regression   1    43356.85    43356.85    134.99  8.87e-28
```
...
## Height      1  43357   43357  134.99 < 2.2e-16 ***
## Residuals 498 159952     321                      
## ---
...
```
## F-statistic from ANOVA: 134.9891
```
...
```
##    Height    Fit CI_Lower CI_Upper PI_Lower PI_Upper
##     <num>  <num>    <num>    <num>    <num>    <num>
## 1:    150  63.81    60.48    67.15    28.44    99.18
## 2:    165  77.65    75.97    79.33    42.40   112.90
## 3:    180  91.49    89.14    93.84    56.20   126.78
## 4:    195 105.32   100.95   109.70    69.84   140.81
```
...
```
##       because they account for both uncertainty in the mean AND
```
...
![plot of chunk prediction_bands](/courses/statistics-1-foundations/prediction_bands-1.png)
...
```
## Research Question: Does height predict weight in adults?
```
...
```
## We examined the relationship between height and weight using simple
```
...
```
## linear regression. The analysis included 500 adults from the NHANES
```
...
```
##   Weight = -74.56 + 0.922 <U+00D7> Height
```
...
```
## Height was a significant predictor of weight (<U+03B2> = 0.922,
```
...
```
## 95% CI [0.766, 1.078], t(498) = 11.62, p < .001).
```
...
```
## For every 1 cm increase in height, weight increased by 0.92 kg
```
...
```
## on average. The model explained 21.3% of the variance in weight
```
...
```
## (R<U+00B2> = 0.213, F(1, 498) = 135.0, p < .001).
```
