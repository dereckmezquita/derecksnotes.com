...
#> Total protocols = 3 <U+00D7> 4 <U+00D7> 2 = 24
...
#>   Verification: 10 <U+00D7> 9 <U+00D7> 8 = 720
...
#> Ways to form target committee: 28 <U+00D7> 10 = 280
...
#> Parents: Aa <U+00D7> Aa (both carriers)
...
#>   = C(3, 2) <U+00D7> (1/2)^2 <U+00D7> (1/2)^1
cat("  =", choose(3, 2), "× 0.25 × 0.5\n")
#>   = 3 <U+00D7> 0.25 <U+00D7> 0.5
cat("  =", prob_2_carriers, "\n\n")
#>   = 0.375
...
#> P(exactly 1 defective) = 4 <U+00D7> 1820 / 15504
...
#> lfactorial(n) <U+2014> Log factorial for large n
...
#> choose(n, k) <U+2014> Binomial coefficient C(n, k)
...
#> P(flush) <U+2248> 0.00198 or about 1 in 505
```
...
#>   Strategy: STAY   -> Win rate: 0.338 (theoretical: 1/3 <U+2248> 0.333)
cat("  Strategy: SWITCH -> Win rate:", round(switch_wins, 3),
    "(theoretical: 2/3 ≈ 0.667)\n\n")
#>   Strategy: SWITCH -> Win rate: NA (theoretical: 2/3 <U+2248> 0.667)
...
#>    Say: 'The probability is approximately 47% (<U+00B1>1%)'
...
#>   <U+2192> Exact is easy and precise here
...
#>   <U+2192> Simulation handles this complex problem easily
```
