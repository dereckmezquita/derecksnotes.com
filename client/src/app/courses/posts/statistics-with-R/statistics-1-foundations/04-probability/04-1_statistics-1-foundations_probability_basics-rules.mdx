...
#> 
#> A ∩ B (Both): 48 patients, P(A ∩ B) = 0.096 
#> A ∪ B (Either): 290 patients, P(A ∪ B) = 0.58 
#> A' (No diabetes): 352 patients, P(A') = 0.704 
#> (A ∪ B)' (Neither): 210 patients, P(neither) = 0.42
```
...
#> 
#> 1. P(∅) = 0: The probability of an impossible event is zero
#>    Example: P(person has both diabetes AND no diabetes) = 0
#> 
#> 2. 0 ≤ P(A) ≤ 1: All probabilities are between 0 and 1
#>    P(Diabetic) = 0.076 
#>    P(Pre-diabetic) = 0 
...
#> 
#> Events:
#>   A = Hypertension (BP ≥ 140 mmHg)
#>   B = Obesity (BMI ≥ 30)
#> 
#> Probabilities:
#>   P(A) = 0.1276 ( 919 of 7205 )
#>   P(B) = 0.3535 ( 2547 of 7205 )
#>   P(A ∩ B) = 0.0509 ( 367 of 7205 )
#> 
#> P(A ∪ B) — Probability of either risk factor:
#>   Wrong (simple sum): P(A) + P(B) = 0.4811 
#>   Correct (addition rule): P(A) + P(B) - P(A ∩ B) = 0.4301 
...
#> P(Female) = 0.502 
#> P(Diabetic) = 0.076 
#> P(Female ∩ Diabetic) = 0.0357 
#> P(Female ∪ Diabetic) = P(F) + P(D) - P(F ∩ D) = 0.5423 
...
#> 
#> • 100 have the disease, 9,900 don't
#> 
