...
<Figure src="/courses/statistics-1-foundations/frequentist_coin_flip-1.png" alt="Convergence of relative frequency to probability">
	Convergence of relative frequency to probability
</Figure>
...
<Figure src="/courses/statistics-1-foundations/bayesian_belief_update-1.png" alt="Bayesian belief updating with diagnostic evidence">
	Bayesian belief updating with diagnostic evidence
</Figure>
...
#> Verifying Kolmogorov's Axioms:

# Axiom 1: Non-negativity
cat("Axiom 1 (Non-negativity): All P(event) >= 0?\n")
#> Axiom 1 (Non-negativity): All P(event) >= 0?
cat("  Probabilities:", frequencies, "\n")
#>   Probabilities: 0.42 0.1 0.04 0.44
...
#> Axiom 3 (Additivity): P(A or B) = P(A) + P(B) for disjoint events?
cat("  P(type A):", p_A, "\n")
#>   P(type A): 0.42
cat("  P(type B):", p_B, "\n")
#>   P(type B): 0.1
...
<Figure src="/courses/statistics-1-foundations/axiom_demonstration-1.png" alt="The axioms constrain probability to the [0, 1] interval">
	The axioms constrain probability to the [0, 1] interval
</Figure>
...
<Figure src="/courses/statistics-1-foundations/inference_chain-1.png" alt="Probability connects samples to populations">
	Probability connects samples to populations
</Figure>

``` r

cat("Population mean BMI:", round(pop_mean, 2), "\n")
#> Population mean BMI: 26.66
cat("Mean of sample means:", round(mean(sample_means), 2), "\n")
#> Mean of sample means: 26.71
cat("SE of sample means:", round(sd(sample_means), 2), "\n")
#> SE of sample means: 1.06
...
<Figure src="/courses/statistics-1-foundations/sample_spaces-1.png" alt="Different types of sample spaces">
...
<Figure src="/courses/statistics-1-foundations/set_operations-1.png" alt="Set operations on events visualised with Venn diagrams">
	Set operations on events visualised with Venn diagrams
</Figure>
...
#> 
#> Simulation verification (10000 rolls):
cat("  Proportion of 3s:", mean(rolls == 3), "\n")
#>   Proportion of 3s: 0.1667
cat("  Proportion odd:", mean(rolls %% 2 == 1), "\n")
#>   Proportion odd: 0.5031
...
<Figure src="/courses/statistics-1-foundations/venn_diagram-1.png" alt="Venn diagram showing relationships between events">
	Venn diagram showing relationships between events
</Figure>
...
<Figure src="/courses/statistics-1-foundations/tree_diagram-1.png" alt="Tree diagram for sequential coin flips">
	Tree diagram for sequential coin flips
</Figure>
...
<Figure src="/courses/statistics-1-foundations/complement_rule-1.png" alt="The complement rule: P(A) + P(A&#39;) = 1">
...
#> The Addition Rule: Medical Risk Factors
cat("=======================================\n\n")
#> =======================================
...
<Figure src="/courses/statistics-1-foundations/addition_rule-1.png" alt="The addition rule corrects for double-counting the intersection">
	The addition rule corrects for double-counting the intersection
</Figure>
...
#> Event: Sum of two dice equals 7
cat("Theoretical P(sum = 7) = 6/36 =", round(p_sum_7_theory, 4), "\n")
#> Theoretical P(sum = 7) = 6/36 = 0.1667
cat("Simulated P(sum = 7) =", p_sum_7_sim, "\n")
#> Simulated P(sum = 7) = 0.1565
```
...
#> =======================
print(prob_table)
#>    Gender Diabetes count probability
#>    <char>   <char> <int>       <num>
#> 1:   male       No  4506      0.4506
#> 2: female       No  4592      0.4592
#> 3:   male      Yes   403      0.0403
#> 4: female      Yes   357      0.0357
#> 5: female             71      0.0071
#> 6:   male             71      0.0071
...
#> Common Probability Misconceptions to Address
cat("=============================================\n\n")
#> =============================================
...
#> Total testing positive: 90 + 495 = 585
cat("Of these, truly have disease: 90\n")
#> Of these, truly have disease: 90
cat("Probability disease if positive:", round(90/total_positives, 3), "(or about 1 in 6)\n")
#> Probability disease if positive: 0.154 (or about 1 in 6)
...
<Figure src="/courses/statistics-1-foundations/natural_frequencies-1.png" alt="Natural frequencies are easier to understand than probabilities">
