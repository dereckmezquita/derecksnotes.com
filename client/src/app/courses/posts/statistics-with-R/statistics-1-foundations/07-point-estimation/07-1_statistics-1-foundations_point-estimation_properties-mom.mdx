...
```
##        n Var(X̄) Empirical Var(X̄) Theoretical SE Empirical SE Theoretical
##    <num>            <num>              <num>        <num>          <num>
## 1:     5            46.34              45.00         6.81           6.71
## 2:    10            22.58              22.50         4.75           4.74
## 3:    25             9.18               9.00         3.03           3.00
## 4:    50             4.46               4.50         2.11           2.12
## 5:   100             2.24               2.25         1.50           1.50
## 6:   200             1.16               1.12         1.08           1.06
```
...
```
##        n P(|X̄ - μ| ≤ ε) Mean of X̄ SD of X̄
##    <num>          <num>     <num>   <num>
## 1:    10          0.486     50.05   3.056
## 2:    25          0.662     50.08   1.961
## 3:    50          0.859     50.03   1.359
## 4:   100          0.945     49.99   1.021
## 5:   250          0.999     50.04   0.647
## 6:   500          1.000     49.99   0.457
## 7:  1000          1.000     49.99   0.305
```
...
```
##   σ̂² = (1/n)Σ(Xᵢ - X̄)² = 98.242 (true: 100)
```
...
```
##   Ratio (MOM/S²) = 0.9900 ≈ (n-1)/n = 0.9900
```
...
```
## Sampling distribution of λ̂ (n = 30):
```
...
```
##   Note: λ̂ is biased! E(1/X̄) ≠ 1/E(X̄)
```
...
```
## True mean = α/β = 6.0, True variance = α/β² = 12.0
```
...
```
## Sampling properties of prevalence estimator p̂:
```
...
```
##        n Mean p̂     Bias SE (emp) SE (theo)      MSE
...
```
##   - Empirical SE matches theoretical √[p(1-p)/n]
```
...
```
##    Like a scale that's properly calibrated — individual weighings
```
...
```
##   - Sample size affects precision (SE ∝ 1/√n)
```
...
```
##   - A single estimate is not the truth — it has uncertainty
```
