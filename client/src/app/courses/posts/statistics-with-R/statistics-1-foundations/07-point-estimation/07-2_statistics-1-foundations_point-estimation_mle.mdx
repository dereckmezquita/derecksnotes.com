...
```
## MLE: p<U+0302> = 0.70 (the value maximising the likelihood)
```
...
```
## True parameters: <U+03BC> = 50, <U+03C3><U+00B2> = 100 (<U+03C3> = 10)
```
...
```
##   <U+03C3><U+0302><U+00B2> = (1/n)<U+03A3>(X<U+1D62> - X<U+0304>)<U+00B2> = 82.490
```
...
```
##   MLE <U+03C3><U+0302><U+00B2> (<U+00F7>n) = 82.490
```
...
```
##   Unbiased S<U+00B2> (<U+00F7>(n-1)) = 83.323
```
...
```
##   Ratio: MLE/Unbiased = 0.9900 <U+2248> (n-1)/n = 0.9900
```
...
```
##   <U+2113>(<U+03BB>) = n log(<U+03BB>) - <U+03BB> <U+03A3>x<U+1D62>
```
...
```
##   d<U+2113>/d<U+03BB> = n/<U+03BB> - <U+03A3>x<U+1D62> = 0
```
...
```
##   <U+03BB><U+0302> = n/<U+03A3>x<U+1D62> = 1/X<U+0304>
```
...
```
## MLE: <U+03BB><U+0302> = 1/X<U+0304> = 0.2230 (true: 0.20)
```
...
```
##        n Mean <U+03BB><U+0302> SD <U+03BB><U+0302> Theoretical SD
##    <num>                 <num>               <num>          <num>
...
```
##   - Mean of <U+03BB><U+0302> <U+2192> true <U+03BB> (consistency)
```
...
```
##   - SD matches <U+221A>(<U+03BB>/n) (asymptotic normality)
```
...
```
## Poisson data: n = 100, <U+03BB><U+0302> = 3.150 (true <U+03BB> = 3)
```
...
```
## By invariance, MLEs of functions of <U+03BB>:
```
...
```
##     MLE: e^(-<U+03BB><U+0302>) = 0.0429 (true: 0.0498)
```
...
```
##     MLE: 1 - <U+03A3><U+2096><U+208C><U+2080><U+00B2> P(k;<U+03BB><U+0302>) = 0.6096 (true: 0.5768)
```
...
```
## Poisson distribution: I(<U+03BB>) = n/<U+03BB>
```
...
```
## SE(<U+03BB><U+0302>) = 1/<U+221A>I(<U+03BB>) = <U+221A>(<U+03BB>/n)
```
...
```
## True parameters: <U+03B1> = 2, <U+03B2> = 5
```
...
```
##   <U+03B1><U+0302> = 1.9055 (SE = 0.2508)
```
...
```
##   <U+03B2><U+0302> = 4.6961 (SE = 0.6675)
```
...
```
##   <U+03B1><U+2080> = 3.429, <U+03B2><U+2080> = 0.559
```
...
```
##   <U+03B1><U+0302> = 3.0546 (SE = 0.3352, true = 3.0)
```
...
```
##   <U+03B2><U+0302> = 0.4975 (SE = 0.0593, true = 0.5)
```
...
```
##   Method of Moments: <U+03B1> = 3.429, <U+03B2> = 0.559
```
...
```
##   True:              <U+03B1> = 3.000, <U+03B2> = 0.500
```
...
```
## True hazard rate: <U+03BB> = 0.15 (mean survival = 6.67 units)
```
...
```
##   <U+03BB><U+0302>_naive = 1/X<U+0304> = 0.1676 (BIASED - underestimates hazard)
```
...
```
##   <U+03BB><U+0302> = d / <U+03A3>t<U+1D62> = 49 / 447.57 = 0.1095
```
...
```
## Standard error: SE(<U+03BB><U+0302>) = <U+03BB><U+0302>/<U+221A>d = 0.0156
```
...
```
##    the same way <U+2014> finding the parameter that best matches the data.'
```
