...
##        → Controls: P(at least 1 false positive)
## 
...
## 
## Key observations:
## • Uncorrected: High sensitivity but many false positives
## • FWER methods: Very few false positives but low sensitivity
## • FDR (BH): Good balance—high sensitivity with controlled FDR
```
...
## • q-value: expected proportion of false positives among all
...
## • π₀ = proportion of null hypotheses
## • f₀(z) = density of test statistics under null
## • f₁(z) = density of test statistics under alternative
## 
## lfdr(z) = π₀ × f₀(z) / [π₀ × f₀(z) + (1-π₀) × f₁(z)]
```
...
## 
## True π₀: 0.90
## Estimated π₀ (Storey's method): 0.948
## 
## If π₀ < 1, we can use adaptive procedures for more power.
...
## 
## Guidelines:
## • FDR = 0.01: Conservative, high confidence in findings
## • FDR = 0.05: Standard choice, balanced
## • FDR = 0.10: Lenient, for exploratory screening
## • FDR = 0.20: Very lenient, for initial discovery
```
