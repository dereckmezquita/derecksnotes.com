...
```
## Known: σ = 5 mg/dL (from instrument specifications)
```
...
```
## Standard Error: SE = σ/√n = 1.00 mg/dL
```
...
```
##   90% CI: 99.83 ± 1.645 × 1.00 = (98.19, 101.48)
```
...
```
##   95% CI: 99.83 ± 1.960 × 1.00 = (97.87, 101.79)
```
...
```
##   99% CI: 99.83 ± 2.576 × 1.00 = (97.26, 102.41)
```
...
```
## Standard Error: SE = s/√n = 3.67 mmHg
```
...
```
## Since σ is estimated (T-interval):
```
