...
## Sample proportion: p̂ = 0.1191 (11.9%)
## 
## Checking normal approximation adequacy:
##   np̂ = 981.0 (should be >= 10) ✓
##   n(1-p̂) = 7256.0 (should be >= 10) ✓
## 
...
##  0.1121019 0.126091695% Wilson interval: (%.4f, %.4f)
##  0.1122789 0.1262698
## 
## Extreme Example: Rare Event (3 successes in 100)
## p̂ = 0.03
## 
## Wald interval:   (0.0000, 0.0634) — note lower bound near 0!
## Wilson interval: (0.0103, 0.0845) — better behaved
```
...
## =========================================================
## 
## Male BP variance: s₁² = 301.04
## Female BP variance: s₂² = 384.88
## Variance ratio (M/F): 0.782
## 
## 95% CI for σ₁²/σ₂²: (0.444, 1.378)
## 
## The CI includes 1, so we cannot conclude variances differ.
## 
