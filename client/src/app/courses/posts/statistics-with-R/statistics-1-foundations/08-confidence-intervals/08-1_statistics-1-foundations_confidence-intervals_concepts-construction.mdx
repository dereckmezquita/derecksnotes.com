...
## 
## Interpretation:
## Each interval either contains μ or doesn't (fixed fact).
## The '95%' refers to the long-run proportion of intervals
## that would contain μ if we repeated sampling many times.
```
...
## =============================================
## 
## Sample: n = 100, x̄ = 49.61, s = 9.77, SE = 0.98
## 
...
##   119.20 ± 3.61 = (115.59, 122.81) mmHg
```
...
## ==================================
## 
## 95% CI for mean: (49.09, 52.72) — width = 3.62
## Data range: (26.91, 71.87) — width = 44.97
## 
## The CI is about WHERE THE MEAN IS, not where the data falls.
```
