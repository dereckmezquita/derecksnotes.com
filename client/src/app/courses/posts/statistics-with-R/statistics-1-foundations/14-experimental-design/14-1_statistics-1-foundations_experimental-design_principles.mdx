...
```
## Balance Check: Mean Health Consciousness by Treatment
```
...
```
##    treatment_biased mean_health     n
##               <num>       <num> <int>
## 1:                0    40.00547    48
## 2:                1    61.83358    52
```
...
```
##    treatment_random mean_health     n
##               <num>       <num> <int>
## 1:                0    48.91192    50
## 2:                1    53.80025    50
```
...
![plot of chunk randomisation_visual](/courses/statistics-1-foundations/randomisation_visual-1.png)
...
```
## <U+2022> 20 patients randomly assigned to drug
```
...
```
## <U+2022> 20 patients randomly assigned to placebo
```
...
```
## <U+2022> Each patient is an independent replicate
```
...
```
## <U+2022> 2 patients get drug, measured 10 times each
```
...
```
## <U+2022> 2 patients get placebo, measured 10 times each
```
...
```
## <U+2022> Multiple measurements on same patient are NOT independent
```
...
```
## Analysis of Blocked Experiment
```
...
```
##   Treatment effect estimate: 5.39
```
...
```
## Note: Blocking reduced the SE by accounting for block-to-block variation!
```
...
![plot of chunk crd_visual](/courses/statistics-1-foundations/crd_visual-1.png)
...
![plot of chunk rcbd_visual](/courses/statistics-1-foundations/rcbd_visual-1.png)
...
```
## Latin Square Design (4 <U+00D7> 4)
```
...
![plot of chunk latin_square_visual](/courses/statistics-1-foundations/latin_square_visual-1.png)
...
![plot of chunk power_elements](/courses/statistics-1-foundations/power_elements-1.png)
...
```
## Required Sample Size for 80% Power (<U+03B1> = 0.05, two-sample t-test)
```
...
```
##       Effect_Size     d n_per_group total_n
##            <char> <num>       <num>   <num>
## 1:  Small (d=0.2)   0.2         394     788
## 2: Medium (d=0.5)   0.5          64     128
## 3:  Large (d=0.8)   0.8          26      52
```
...
```
## Power for One-Way ANOVA (4 groups, f = 0.25 medium effect)
```
...
```
## 
## Need approximately n = 45 per group (total N = 180) for 80% power.
```
...
```
## Disentangling Treatment Effects
```
...
```
##           group Mean_Improvement       SD
##          <char>            <num>    <num>
## 1: No Treatment         0.000000 0.000000
## 2:      Placebo         2.928156 3.273059
## 3:         Drug         8.032773 2.987565
```
...
```
## <U+2022> Total drug effect (vs no treatment): 8 units
```
...
```
## <U+2022> True pharmacological effect: 5 units (Drug - Placebo)
```
...
##                           Question                Good_Study
##                             <char>                    <char>
## 1:           1. Random assignment?    Yes, with clear method
## 2:        2. Adequate sample size?   Power analysis reported
## 3:   3. Appropriate control group? Placebo or active control
## 4:    4. Blinding (single/double)?    Double-blind preferred
## 5: 5. Intention-to-treat analysis?       Yes, all randomised
## 6:       6. All outcomes reported?       Primary + secondary
## 7:     7. Pre-registered protocol?   Yes, publicly available
##                     Red_Flag
##                       <char>
## 1: Self-selection or unclear
## 2: Small n, no justification
## 3:  No control or historical
## 4:     Open-label or unclear
## 5:         Per-protocol only
