...
## 
## PROPER REPLICATION:
## • 20 patients randomly assigned to drug
## • 20 patients randomly assigned to placebo
## • Each patient is an independent replicate
## 
## PSEUDOREPLICATION (WRONG!):
## • 2 patients get drug, measured 10 times each
## • 2 patients get placebo, measured 10 times each
## • n = 2 per group, NOT 20!
## • Multiple measurements on same patient are NOT independent
```
...
```
## Required Sample Size for 80% Power (α = 0.05, two-sample t-test)
## ================================================================
## 
...
## 
## Interpretation:
## • Total drug effect (vs no treatment): 8 units
## • Placebo effect: 3 units
## • True pharmacological effect: 5 units (Drug - Placebo)
## 
## Without placebo control, we would overestimate the drug's effect!
```
