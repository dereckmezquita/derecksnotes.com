...
## ====================================================
## 
## H₀: Blood types are equally distributed (25% each)
## 
##    Blood Type Observed Expected (O-E)²/E
##        <char>    <num>    <num>    <num>
## 1:          A       42       25    11.56
## 2:          B       18       25     1.96
## 3:         AB        8       25    11.56
...
## ======================================================
## 
## H₀: Sample follows US population blood type distribution
## 
##    Blood Type Observed Expected (US) (O-E)²/E
##        <char>    <num>         <num>    <num>
## 1:          A       42            42 0.000000
## 2:          B       18            10 6.400000
## 3:         AB        8             4 4.000000
...
```
## Contingency Table: Smoking Status × Diabetes
## =============================================
## 
##        Diabetes
## Smoking   No  Yes
...
<div class="figure">
<img src="/courses/statistics-1-foundations/contingency_visual-1.png" alt="Mosaic plot of smoking × diabetes" width="100%" />
<p class="caption">Mosaic plot of smoking × diabetes</p>
</div>
...
```
## Larger Contingency Table: Age × Education
## ==========================================
## 
##        
...
## 
## χ² = 129.081, df = 9, p = 0.0000
## Cramér's V = 0.0953 (negligible effect)
```
...
## ============================
## 
## Without correction: χ² = 50.705, p = 0.0000
## With Yates' correction: χ² = 49.921, p = 0.0000
## 
## Note: Yates' correction makes the test more conservative.
## It's automatic in R's chisq.test() for 2×2 tables.
```
