...
## 
## H₀: μ = 120 mmHg
## H₁: μ ≠ 120 mmHg (two-sided)
## 
## Sample size: n = 50
## Sample mean: x̄ = 117.56 mmHg
...
```
## Type I Error Rate Check (α = 0.05)
## ==================================
## 
## Normal data: 0.0524 (should be ≈ 0.05)
## Exponential data: 0.0756 (should be ≈ 0.05)
```
...
## between males and females. However, the effect size suggests the practical
