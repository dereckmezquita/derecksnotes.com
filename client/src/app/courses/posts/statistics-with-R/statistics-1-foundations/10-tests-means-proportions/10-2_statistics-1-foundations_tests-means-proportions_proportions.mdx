...
## Sample proportion: p̂ = 0.1191
## Hypothesised proportion: p₀ = 0.30
## 
## Assumption check:
##   np₀ = 2471.1 (should be ≥ 10)
##   n(1-p₀) = 5765.9 (should be ≥ 10)
## 
## Standard error (under H₀): SE = √[p₀(1-p₀)/n] = 0.0050
...
## ==============================================
## 
## One-proportion test (detecting p = 0.35 vs H₀: p = 0.30):
##   n = 676 (80% power, α = 0.05, two-sided)
## 
## Two-proportion test (detecting p₁ = 0.35 vs p₂ = 0.25):
##   n = 329 per group (80% power, α = 0.05, two-sided)
## 
...
## prevalence between smokers and non-smokers. The effect size is relatively small.
```
