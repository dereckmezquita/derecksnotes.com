...
<div class="figure">
<img src="/courses/statistics-1-foundations/pvalue_visual-1.png" alt="P-value as area in the tails" width="100%" />
<p class="caption">P-value as area in the tails</p>
</div>
...
```
## <U+274C> WRONG: 'p = 0.03 means there's a 3% chance H<U+2080> is true'
```
...
```
## <U+2713> RIGHT:  'If H<U+2080> is true, we'd see data this extreme only 3% of the time'
```
...
```
## <U+274C> WRONG: 'p = 0.03 means there's a 97% chance the effect is real'
```
...
```
## <U+2713> RIGHT:  'The p-value says nothing about the probability of H<U+2081>'
```
...
```
## <U+274C> WRONG: 'Not significant means no effect exists'
```
...
```
## <U+2713> RIGHT:  'Not significant means insufficient evidence to reject H<U+2080>'
```
...
```
## <U+274C> WRONG: 'p = 0.049 is significant, p = 0.051 is not, so they're different'
```
...
```
## <U+2713> RIGHT:  'These p-values represent nearly identical evidence'
```
...
<div class="figure">
<img src="/courses/statistics-1-foundations/pvalue_distribution-1.png" alt="Distribution of p-values under H&lt;U+2080&gt; and H&lt;U+2081&gt;" width="100%" />
<p class="caption">Distribution of p-values under H<U+2080> and H<U+2081></p>
</div>
...
<div class="figure">
<img src="/courses/statistics-1-foundations/error_types-1.png" alt="Type I and Type II errors illustrated" width="100%" />
<p class="caption">Type I and Type II errors illustrated</p>
</div>
...
<div class="figure">
<img src="/courses/statistics-1-foundations/error_tradeoff-1.png" alt="The trade-off between Type I and Type II errors" width="100%" />
<p class="caption">The trade-off between Type I and Type II errors</p>
</div>
...
```
## Relative Severity of Errors by Context
```
...
```
##                   Context              Type I (False Positive)
##                    <char>                               <char>
## 1:          Drug approval             Approve ineffective drug
## 2:         Criminal trial              Convict innocent person
## 3:      Disease screening Healthy person treated unnecessarily
## 4:        Quality control                Good product rejected
## 5: Scientific publication            False discovery published
##      Type II (False Negative) Usually Worse
##                        <char>        <char>
## 1:      Reject effective drug        Type I
## 2:       Acquit guilty person        Type I
## 3: Sick person goes untreated       Type II
## 4:  Defective product shipped       Depends
## 5:         Real effect missed        Type I
```
...
<div class="figure">
<img src="/courses/statistics-1-foundations/power_vs_effect-1.png" alt="Power increases with effect size" width="100%" />
<p class="caption">Power increases with effect size</p>
</div>
...
<div class="figure">
<img src="/courses/statistics-1-foundations/power_vs_n-1.png" alt="Power increases with sample size" width="100%" />
<p class="caption">Power increases with sample size</p>
</div>
...
```
## Sample Size Calculations (80% Power, <U+03B1> = 0.05, Two-sided)
```
...
```
## Effect size d = 0.2 (small): n = 197 per group
## Effect size d = 0.5 (medium): n = 32 per group
## Effect size d = 0.8 (large): n = 13 per group
```
...
<div class="figure">
<img src="/courses/statistics-1-foundations/power_curve-1.png" alt="Power curves for different sample sizes" width="100%" />
<p class="caption">Power curves for different sample sizes</p>
</div>
...
```
## Duality Between CI and Hypothesis Tests
```
...
```
##      mu0 t_stat p_value  in_ci reject
##    <num>  <num>   <num> <lgcl> <lgcl>
## 1:   4.0  3.924  0.0005  FALSE   TRUE
## 2:   5.0  1.133  0.2666   TRUE  FALSE
## 3:   5.5 -0.263  0.7944   TRUE  FALSE
## 4:   6.0 -1.659  0.1079   TRUE  FALSE
## 5:   7.0 -4.450  0.0001  FALSE   TRUE
```
...
```
## 
## Note: <U+03BC><U+2080> is rejected (p < 0.05) if and only if <U+03BC><U+2080> is outside the CI.
```
...
<div class="figure">
<img src="/courses/statistics-1-foundations/ci_test_duality-1.png" alt="Duality between CI and hypothesis testing" width="100%" />
<p class="caption">Duality between CI and hypothesis testing</p>
</div>
...
<div class="figure">
<img src="/courses/statistics-1-foundations/pvalue_cliff-1.png" alt="The arbitrary cliff at p = 0.05" width="100%" />
<p class="caption">The arbitrary cliff at p = 0.05</p>
</div>
...
```
## Treatment group: M = 9.86, SD = 2.94, n = 30
```
...
```
## Control group: M = 8.54, SD = 2.51, n = 30
```
...
```
## 
## Mean difference: 1.32 (95% CI: -0.09 to 2.74)
```
