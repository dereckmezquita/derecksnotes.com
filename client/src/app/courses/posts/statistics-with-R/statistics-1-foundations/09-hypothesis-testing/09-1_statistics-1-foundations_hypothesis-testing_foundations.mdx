...
```
## Null hypothesis: <U+03BC> = 120 mmHg
```
...
```
## Alternative: <U+03BC> <U+2260> 120 mmHg (two-sided)
```
...
```
## Proportion of simulated z-scores beyond <U+00B1>1.96:
```
...
<div class="figure">
<img src="/courses/statistics-1-foundations/rare_events-1.png" alt="Extreme values are rare when H&lt;U+2080&gt; is true" width="100%" />
<p class="caption">Extreme values are rare when H<U+2080> is true</p>
</div>
...
```
## Z-Test for a Mean (<U+03C3> known)
```
...
```
## H<U+2081>: <U+03BC> <U+2260> 120 (two-sided)
```
...
```
## Test statistic: z = (120.49 - 120) / (15/<U+221A>40) = 0.207
```
...
## Conclusion: Insufficient evidence that <U+03BC> <U+2260> 120
```
...
```
## T-Test for a Mean (<U+03C3> unknown)
```
...
```
## Test statistic: t = (120.49 - 120) / (10.66/<U+221A>40) = 0.292
```
...
```
## Two-sided (H<U+2081>: <U+03BC> <U+2260> <U+03BC><U+2080>): p = 0.0455
```
...
```
## One-sided (H<U+2081>: <U+03BC> > <U+03BC><U+2080>): p = 0.0228
```
...
```
## One-sided (H<U+2081>: <U+03BC> < <U+03BC><U+2080>): p = 0.9772
```
...
```
## Significance level: <U+03B1> = 0.05
```
...
```
##   Since p = 0.0214 < 0.05 = <U+03B1>, reject H<U+2080>
```
...
```
##   Since |z| = 2.30 > 1.960 = z*, reject H<U+2080>
```
