...
#> 
#> Gene 8363 (true log2FC = 0.711 ):
#>   Intercept: 4.036 ± 0.131 
#>   Log FC (natural): 0.644 ± 0.177 
#>   Log2 FC: 0.929 
#>   Dispersion: 0.033 
#> 
#> Gene 1 (true log2FC = 0 ):
#>   Intercept: 5.875 ± 0.186 
#>   Log FC (natural): -0.385 ± 0.264 
#>   Log2 FC: -0.556 
#>   Dispersion: 0.1007
```
...
<Figure src="/courses/statistics-3-advanced/dispersion_estimation-1.png" alt="Dispersion estimation: gene-specific estimates are shrunk toward a common trend">
	Dispersion estimation: gene-specific estimates are shrunk toward a common trend
</Figure>
...
<Figure src="/courses/statistics-3-advanced/multiple_testing-1.png" alt="Multiple testing correction dramatically changes significance thresholds">
	Multiple testing correction dramatically changes significance thresholds
</Figure>
...
#>    expr_group n_genes n_sig_raw n_sig_adj prop_sig
#>        <fctr>   <int>     <int>     <int>    <num>
#> 1:         Q1    2000        21         0   0.0000
#> 2:         Q2    2000        77         0   0.0000
#> 3:         Q3    2000       114        13   0.0065
#> 4:         Q4    2000        92         2   0.0010
#> 5:         Q5    2000        99         1   0.0005
...
#> IHW exploits this by weighting hypotheses based on mean expression.
```
...
<Figure src="/courses/statistics-3-advanced/lfc_shrinkage-1.png" alt="Log fold change shrinkage reduces noise for lowly expressed genes">
	Log fold change shrinkage reduces noise for lowly expressed genes
</Figure>
...
<Figure src="/courses/statistics-3-advanced/volcano_plot-1.png" alt="Volcano plot: combining statistical significance with effect size">
	Volcano plot: combining statistical significance with effect size
</Figure>
...
<Figure src="/courses/statistics-3-advanced/ma_plot_sig-1.png" alt="MA plot highlighting significant genes">
	MA plot highlighting significant genes
</Figure>
...
<Figure src="/courses/statistics-3-advanced/heatmap_de-1.png" alt="Heatmap of top differentially expressed genes">
...
#> Performance Evaluation (FDR < 0.05):
cat("====================================\n")
#> ====================================
...
<Figure src="/courses/statistics-3-advanced/roc_pr_curves-1.png" alt="ROC and precision-recall curves for DE detection">
	ROC and precision-recall curves for DE detection
</Figure>
