...
```{r bootstrap_principle, fig.cap="The bootstrap principle: resampling with replacement"}
...
```{r bootstrap_se, fig.cap="Bootstrap SEs for various statistics"}
# Bootstrap function
...
```{r correlation_bootstrap, fig.cap="Bootstrap distribution of correlation coefficient"}
...
```{r bca_ci, fig.cap="Comparison of bootstrap CI methods"}
...
```{r regression_bootstrap, fig.cap="Bootstrap inference for regression coefficients"}
...
```{r parametric_bootstrap, fig.cap="Parametric vs nonparametric bootstrap for exponential data"}
...
```{r bootstrap_convergence, fig.cap="Bootstrap convergence: standard error stabilises with increasing B"}
# Assess convergence
B_max <- 5000
