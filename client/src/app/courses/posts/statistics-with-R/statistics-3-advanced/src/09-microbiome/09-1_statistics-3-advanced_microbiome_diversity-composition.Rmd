...
```{r simulate_microbiome, message=FALSE}
...
```{r compositional_problem, fig.cap="Compositional data creates spurious correlations"}
...
```{r alpha_diversity, fig.cap="Alpha diversity metrics capture different aspects of community structure"}
...
```{r rarefaction_curves, fig.cap="Rarefaction curves show whether sequencing depth is sufficient"}
...
```{r ordination_pcoa, fig.cap="PCoA ordination reveals community structure"}
...
```{r zero_handling, fig.cap="Different zero-handling strategies affect distributions"}
