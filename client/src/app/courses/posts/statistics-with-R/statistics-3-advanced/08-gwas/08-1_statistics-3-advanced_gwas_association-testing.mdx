...
#>   Chromosomes: 22 
#>   Causal SNPs: 50 
#>   Target heritability: 0.3 
#>   Realised heritability: 0.245
```
...
```
#> Single SNP Association Test Examples:
#> =====================================
#> 
#> Causal SNP (true beta = -0.4469 ):
#>   Estimated beta: -0.4632 
#>   SE: 0.0234 
#>   t-statistic: -19.82 
#>   P-value: 3.02e-84 
#> 
#> Non-causal SNP (true beta = 0):
#>   Estimated beta: 0.0383 
#>   SE: 0.0292 
#>   t-statistic: 1.31 
#>   P-value: 0.189
```
...
#> ===================
#>   SNPs tested: 50000 
#>   Significant at p < 5e-8: 13 
#>   Significant at p < 1e-5: 16 
#>   Minimum p-value: 3.02e-84
```
...
<Figure src="/courses/statistics-3-advanced/multiple_testing-1.png" alt="GWAS requires stringent significance thresholds">
	GWAS requires stringent significance thresholds
</Figure>
...
#> 
#> Expected false positives under the null:
#>   p < 5e-02: Expected 2500.0, Observed 2432
#>   p < 1e-02: Expected 500.0, Observed 477
#>   p < 1e-03: Expected 50.0, Observed 44
#>   p < 1e-05: Expected 0.5, Observed 0
#>   p < 5e-08: Expected 0.0, Observed 0
```
...
#> =========================
#>   Lambda (all SNPs): 1.025 
#>   Lambda (null SNPs only): 1.023 
#>   Good: No systematic inflation in null SNPs.
```
...
<Figure src="/courses/statistics-3-advanced/manhattan_plot-1.png" alt="Manhattan plot showing genome-wide association results">
	Manhattan plot showing genome-wide association results
</Figure>
...
<Figure src="/courses/statistics-3-advanced/qq_plot_full-1.png" alt="QQ plot with causal SNPs highlighted">
	QQ plot with causal SNPs highlighted
</Figure>
...
<Figure src="/courses/statistics-3-advanced/snp_qc-1.png" alt="SNP quality control metrics">
	SNP quality control metrics
</Figure>

```
#> SNP Quality Control Summary:
#> ============================
#>   MAF < 0.01: 50000 SNPs would be filtered
#>   MAF < 0.05: 50000 SNPs would be filtered
#>   HWE p < 1e-6: 0 SNPs would be filtered
```
...
<Figure src="/courses/statistics-3-advanced/sample_qc-1.png" alt="Sample quality control metrics">
...
#>   Heterozygosity outliers: 0 samples
```
...
```
#> GWAS Performance at Various Thresholds:
#> =======================================
#>    threshold    TP    FP sensitivity   PPV
#>       <char> <int> <int>       <num> <num>
#> 1:     5e-08    13     0        0.26 1.000
#> 2:     1e-07    14     0        0.28 1.000
#> 3:     1e-06    15     0        0.30 1.000
#> 4:     1e-05    16     0        0.32 1.000
#> 5:     1e-04    20     9        0.40 0.690
#> 6:     1e-03    22    44        0.44 0.333
```
...
<Figure src="/courses/statistics-3-advanced/effect_size_estimation-1.png" alt="Effect size estimation accuracy for causal SNPs">
	Effect size estimation accuracy for causal SNPs
</Figure>

```
#> Effect Size Estimation (Causal SNPs):
#> =====================================
#>   Correlation (estimated vs true): 0.976 
