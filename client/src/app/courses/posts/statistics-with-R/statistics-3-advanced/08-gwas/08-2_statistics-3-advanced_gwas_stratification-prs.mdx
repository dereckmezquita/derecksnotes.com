...
#> Simulated Stratified GWAS Data:
cat("===============================\n")
#> ===============================
...
#> Naive GWAS Results (Ignoring Population Structure):
cat("===================================================\n")
#> ===================================================
cat("  Significant at p < 5e-8:", sum(naive_gwas$p_value < 5e-8), "\n")
#>   Significant at p < 5e-8: 136
...
#>   Genomic inflation (<U+03BB>): 4.869
...
<Figure src="/courses/statistics-3-advanced/demonstrate_confounding-1.png" alt="Population stratification creates spurious associations">
	Population stratification creates spurious associations
</Figure>
...
#>   Variance explained by PC1-10: 1.61 %
...
<Figure src="/courses/statistics-3-advanced/ancestry_pca-1.png" alt="PCA reveals population structure in genotype data">
	PCA reveals population structure in genotype data
</Figure>
...
#>   Genomic inflation (<U+03BB>): 1.006

cat("\nComparison:\n")
#> 
#> Comparison:
cat("  λ without PCs:", round(lambda_naive, 3), "\n")
#>   <U+03BB> without PCs: 4.869
cat("  λ with PCs:", round(lambda_pcs, 3), "\n")
#>   <U+03BB> with PCs: 1.006
...
<Figure src="/courses/statistics-3-advanced/gwas_with_pcs-1.png" alt="Including PCs as covariates corrects for stratification">
	Including PCs as covariates corrects for stratification
</Figure>
...
<Figure src="/courses/statistics-3-advanced/grm_calculation-1.png" alt="Genetic relationship matrix captures population structure">
	Genetic relationship matrix captures population structure
</Figure>
...
#>   Genomic inflation (<U+03BB>) with MM: 55.405
cat("  Compare to PC correction:", round(lambda_pcs, 3), "\n")
#>   Compare to PC correction: 1.006
```
...
#>   Mean r<U+00B2> (adjacent SNPs): 0
cat("  Mean r² (all pairs):", round(mean(ld_matrix, na.rm = TRUE), 3), "\n")
#>   Mean r<U+00B2> (all pairs): 0.01
...
<Figure src="/courses/statistics-3-advanced/ld_calculation-1.png" alt="Linkage disequilibrium between nearby SNPs">
...
#>    threshold n_snps r2_phenotype r_genetic
#>       <char>  <int>        <num>     <num>
#> 1:     5e-08     14       0.2765     0.933
#> 2:     1e-05     18       0.2877     0.971
#> 3:     1e-03     33       0.3111     0.940
#> 4:     1e-02    116       0.3630     0.826
#> 5:     5e-02    534       0.4691     0.693
#> 6:     1e-01   1000       0.5260     0.663
#> 7:     5e-01   5020       0.6515     0.606
#> 8:     1e+00  10000       0.6578     0.604
...
<Figure src="/courses/statistics-3-advanced/prs_calculation-1.png" alt="Polygenic risk scores predict phenotype">
	Polygenic risk scores predict phenotype
</Figure>
...
<Figure src="/courses/statistics-3-advanced/prs_threshold_plot-1.png" alt="PRS performance varies with p-value threshold">
	PRS performance varies with p-value threshold
</Figure>
...
#> Phenotype by PRS Decile:
cat("========================\n")
#> ========================
print(decile_summary[order(risk_decile)])
#>     risk_decile mean_phenotype se_phenotype     n
#>          <fctr>          <num>        <num> <int>
#>  1:           1    -1.39421320   0.03033604   500
#>  2:           2    -0.84838763   0.02576509   500
#>  3:           3    -0.58233561   0.02662669   500
#>  4:           4    -0.29686055   0.02666886   500
#>  5:           5    -0.11159421   0.02566314   500
#>  6:           6     0.06070585   0.02561494   500
#>  7:           7     0.34513869   0.02621525   500
#>  8:           8     0.57167512   0.02646528   500
#>  9:           9     0.82902026   0.02718876   500
#> 10:          10     1.42685129   0.03182491   500
...
<Figure src="/courses/statistics-3-advanced/prs_risk_stratification-1.png" alt="PRS stratifies individuals by genetic risk">
	PRS stratifies individuals by genetic risk
</Figure>
