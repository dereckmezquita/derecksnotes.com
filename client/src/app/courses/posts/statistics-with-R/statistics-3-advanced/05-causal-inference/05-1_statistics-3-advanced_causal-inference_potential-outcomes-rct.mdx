...
#> Potential Outcomes (We Cannot See All of This!)
cat("================================================\n")
#> ================================================
print(demo_display)
#>     Subject  Y(0)  Y(1) True Effect
#>       <int> <num> <num>       <num>
#>  1:       1   150   152         1.6
#>  2:       2   153   146        -7.4
#>  3:       3   132   127        -5.1
...
<Figure src="/courses/statistics-3-advanced/fundamental_problem-1.png" alt="The fundamental problem: we observe only one potential outcome per subject">
	The fundamental problem: we observe only one potential outcome per subject
</Figure>
...
#> True Average Treatment Effect (ATE): -10.22 mmHg
...
#>   ATT (effect on treated): -10.43 mmHg
cat("  ATC (effect on controls):", round(atc, 2), "mmHg\n")
#>   ATC (effect on controls): -9.96 mmHg
cat("  Expected relationship ATE = P(W=1)*ATT + P(W=0)*ATC:\n")
#>   Expected relationship ATE = P(W=1)*ATT + P(W=0)*ATC:
...
<Figure src="/courses/statistics-3-advanced/estimands-1.png" alt="Different causal estimands answer different questions">
	Different causal estimands answer different questions
</Figure>
...
#>               group mean_baseline_bp  mean_y0
#>              <char>            <num>    <num>
#> 1: Control (Biased)         131.0551 131.4134
#> 2: Treated (Biased)         148.5732 148.6870
```
...
<Figure src="/courses/statistics-3-advanced/bias_visualisation-1.png" alt="Selection bias arises when treated and control groups are not comparable">
	Selection bias arises when treated and control groups are not comparable
</Figure>
...
<Figure src="/courses/statistics-3-advanced/randomisation_power-1.png" alt="Randomisation makes treatment and control groups comparable across ALL variables">
	Randomisation makes treatment and control groups comparable across ALL variables
</Figure>
...
#> ATE Estimation from Randomised Trial:
cat("=====================================\n")
#> =====================================
cat("  Point estimate:", round(ate_estimate, 2), "mmHg\n")
#>   Point estimate: -8.79 mmHg
...
<Figure src="/courses/statistics-3-advanced/sampling_distribution-1.png" alt="Sampling distribution of the ATE estimator under repeated randomisation">
	Sampling distribution of the ATE estimator under repeated randomisation
</Figure>
...
<Figure src="/courses/statistics-3-advanced/randomisation_inference-1.png" alt="Randomisation distribution under Fisher&#39;s sharp null hypothesis">
	Randomisation distribution under Fisher's sharp null hypothesis
</Figure>
...
#> 95% Confidence Interval by Test Inversion:
cat("==========================================\n")
#> ==========================================
...
<Figure src="/courses/statistics-3-advanced/ci_inversion-1.png">
...
<Figure src="/courses/statistics-3-advanced/covariate_adjustment-1.png" alt="Covariate adjustment increases precision in RCTs">
	Covariate adjustment increases precision in RCTs
</Figure>
...
#> Balance Check After Stratified Randomisation:
cat("=============================================\n")
#> =============================================
print(balance_check)
#>    bp_stratum n_treated n_control mean_bp_treated mean_bp_control
#>        <fctr>     <num>     <num>           <num>           <num>
#> 1:       High        89        89        155.6517        155.8539
#> 2:     Medium        92        93        138.5000        138.1290
#> 3:        Low        68        69        120.5294        120.7101
...
#>    bp_stratum     n   n_t   n_c   ate weight
#>        <fctr> <int> <num> <num> <num>  <num>
#> 1:       High   178    89    89 -9.44  0.356
#> 2:     Medium   185    92    93 -9.36  0.370
#> 3:        Low   137    68    69 -9.50  0.274
