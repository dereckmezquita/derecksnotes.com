...
#> ========================
#>   Mean CV error at selected lambda: 0.3619 
#>   Mean true test error: 0.1731 
#>   Mean bias (CV - true): 0.1888 
#>   Percentage of times CV is optimistic: 0 %
```
...
<Figure src="/courses/statistics-3-advanced/bias_plot-1.png" alt="CV error tends to be optimistic compared to true test error">
	CV error tends to be optimistic compared to true test error
</Figure>
...
<Figure src="/courses/statistics-3-advanced/nested_cv_visual-1.png" alt="Nested CV structure: outer loop estimates error, inner loop selects hyperparameters">
	Nested CV structure: outer loop estimates error, inner loop selects hyperparameters
</Figure>
...
#> ================================
#>   Nested CV error: 0.1464 
#>   SE: 0.0096 
#>   Selected lambdas per fold: 0.0026 0.0026 0.0033 0.0026 0.0042
```
...
#> Comparison Summary:
#> ===================
#>   Mean single-level CV: 0.3628 
#>   Mean nested CV: 0.1572 
#>   Mean true error: 0.1756 
#> 
#>   Single-level bias: 0.1872 
#>   Nested CV bias: -0.0184
```
...
<Figure src="/courses/statistics-3-advanced/comparison_plot-1.png">
...
<Figure src="/courses/statistics-3-advanced/calibration_plot-1.png" alt="Calibration plot: comparing predicted probabilities to observed outcomes">
	Calibration plot: comparing predicted probabilities to observed outcomes
</Figure>
...
#> ====================
#>   Brier score: 0.0511 
#>   Mean predicted: 0.3663 
#>   Mean observed: 0.345 
#>   Calibration intercept: 0.142 (should be ~0)
#>   Calibration slope: 2.0277 (should be ~1)
```
...
#> ======================
#>   Brier score (uncalibrated): 0.099 
#>   Brier score (Platt calibrated): 0.0378
```
...
<Figure src="/courses/statistics-3-advanced/isotonic-1.png" alt="Isotonic regression provides non-parametric calibration">
...
```
#> Complete Model Assessment (Nested 5-Fold CV):
#> =============================================
#> 
#> Per-fold results:
#>     fold log_loss  brier   auc
#>    <int>    <num>  <num> <num>
#> 1:     1   0.1881 0.0560 0.986
#> 2:     2   0.1505 0.0390 0.994
#> 3:     3   0.1664 0.0445 0.987
#> 4:     4   0.1665 0.0445 0.984
#> 5:     5   0.2198 0.0641 0.977
#> 
#> Summary statistics:
#>   Log-loss: 0.1782 ± 0.0268 
#>   Brier: 0.0496 ± 0.0102 
#>   AUC: 0.986 ± 0.006 
#> 
#> Calibration (mean predicted vs observed):
#>   Mean predicted: 0.372 
#>   Mean observed: 0.373
```
