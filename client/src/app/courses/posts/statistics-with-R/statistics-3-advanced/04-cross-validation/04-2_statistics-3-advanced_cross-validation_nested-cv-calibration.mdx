...
<Figure src="bias_plot-1.png" alt="CV error tends to be optimistic compared to true test error">
...
<Figure src="nested_cv_visual-1.png" alt="Nested CV structure: outer loop estimates error, inner loop selects hyperparameters">
...
<Figure src="comparison_plot-1.png">
...
<Figure src="calibration_plot-1.png" alt="Calibration plot: comparing predicted probabilities to observed outcomes">
