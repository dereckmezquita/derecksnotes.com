...
<img src="/courses/statistics-3-advanced/simulate_clinical_data-1.png" alt="plot of chunk simulate_clinical_data" width="100%" />
<p class="caption">plot of chunk simulate_clinical_data</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="/courses/statistics-3-advanced/bayes_factor_computation-1.png" alt="plot of chunk bayes_factor_computation" width="100%" />
<p class="caption">plot of chunk bayes_factor_computation</p>
</div>
...
```
##     site       bf         interpretation
##    <int>    <num>                 <char>
## 1:     1  7107.64    Decisive for effect
## 2:     2     7.91    Moderate for effect
## 3:     3     1.75        Weak for effect
## 4:     4   119.07    Decisive for effect
## 5:     5    49.34 Very strong for effect
## 6:     6     2.06        Weak for effect
## 7:     7     0.38          Weak for null
## 8:     8 81419.42    Decisive for effect
```
...
```
## Model Comparison Metrics (Hierarchical Model):
```
...
```
##   p_waic (effective parameters): NaN
```
...
<div class="figure" style="text-align: center">
<img src="/courses/statistics-3-advanced/information_criteria-1.png" alt="plot of chunk information_criteria" width="100%" />
<p class="caption">plot of chunk information_criteria</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="/courses/statistics-3-advanced/posterior_predictive-1.png" alt="plot of chunk posterior_predictive" width="100%" />
<p class="caption">plot of chunk posterior_predictive</p>
</div>
...
```
##      statistic    observed   rep_mean    rep_sd p_value
##         <char>       <num>      <num>     <num>   <num>
## 1:        Mean -4.49381309 -4.5160999 0.4683476    0.53
## 2:          SD 11.13551050  4.9501400 0.5301155    0.00
## 3:    Skewness -0.10405382 -0.4621081 0.2041132    0.02
## 4: P(|y| > 20)  0.08333333  0.0000000 0.0000000    0.00
```
...
<div class="figure" style="text-align: center">
<img src="/courses/statistics-3-advanced/graphical_ppc-1.png" alt="plot of chunk graphical_ppc" width="100%" />
<p class="caption">plot of chunk graphical_ppc</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="/courses/statistics-3-advanced/graphical_ppc-2.png" alt="plot of chunk graphical_ppc" width="100%" />
<p class="caption">plot of chunk graphical_ppc</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="/courses/statistics-3-advanced/mathematical_illustration-1.png" alt="plot of chunk mathematical_illustration" width="100%" />
<p class="caption">plot of chunk mathematical_illustration</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="/courses/statistics-3-advanced/stakeholder_report-1.png" alt="plot of chunk stakeholder_report" width="100%" />
<p class="caption">plot of chunk stakeholder_report</p>
</div>
...
```
## - Multi-site clinical trial with 8 sites and 240 patients
```
...
```
## - Testing blood pressure reduction treatment
```
...
```
## - Comparing hierarchical (site-specific) vs pooled (single effect) models
```
...
```
## - Unable to compute WAIC difference
```
...
```
## - Hierarchical model uses NaN effective parameters vs NaN for pooled
```
...
```
## - This extra complexity is NOT JUSTIFIED by improved prediction
```
...
```
## - Treatment effect is CONSISTENT across sites
## - A single effect estimate can be used for all sites
```
...
```
##                                   Model  WAIC Effective Parameters  lppd
##                                  <char> <num>                <num> <num>
## 1: Hierarchical (Site-specific effects)   NaN                  NaN   NaN
## 2:               Pooled (Single effect)   NaN                  NaN   NaN
##    Delta WAIC
##         <num>
## 1:        NaN
## 2:        NaN
...
```
##   MODEL ADEQUACY REPORT (REGULATORY SUBMISSION)
```
...
```
## - Hierarchical Bayesian model with site-specific treatment effects
```
...
```
## - Normal likelihood with estimated residual variance
```
...
```
## - Half-normal prior on between-site standard deviation
```
...
```
##             Test Statistic   Observed Model Prediction     95% Interval
##                     <char>     <char>           <char>           <char>
## 1:                    Mean -4.49 mmHg       -4.52 mmHg   [-5.40, -3.72]
## 2:      Standard Deviation 11.14 mmHg        4.95 mmHg     [3.99, 5.83]
## 3:                Skewness     -0.104           -0.462 [-0.826, -0.131]
## 4: Extreme Values (|y|>20)       8.3%             0.0%     [0.0%, 0.0%]
##    Assessment
##        <char>
## 1:       PASS
## 2:     REVIEW
...
```
## - PASS: Observed value falls within expected range from model
```
...
```
## - REVIEW: Potential model misspecification; further investigation needed
```
...
```
## OVERALL ASSESSMENT: MODEL REQUIRES REVIEW
```
...
```
## CONCLUSION:
## Some aspects of the observed data are not well captured by the model.
## Consider model refinements before finalising efficacy estimates.
```
