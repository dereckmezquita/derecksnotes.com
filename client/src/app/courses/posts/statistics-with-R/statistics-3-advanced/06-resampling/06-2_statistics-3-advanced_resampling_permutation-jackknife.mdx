...
<Figure src="/courses/statistics-3-advanced/permutation_principle-1.png" alt="Permutation test: generating the null distribution by shuffling labels">
...
<Figure src="/courses/statistics-3-advanced/permutation_correlation-1.png" alt="Permutation test for correlation coefficient">
...
<Figure src="/courses/statistics-3-advanced/permutation_regression-1.png" alt="Permutation test for regression F-statistic">
	Permutation test for regression F-statistic
</Figure>
...
<Figure src="/courses/statistics-3-advanced/jackknife_basics-1.png" alt="Jackknife leave-one-out estimates">
...
<Figure src="/courses/statistics-3-advanced/jackknife_influence-1.png" alt="Jackknife pseudo-values identify influential observations">
	Jackknife pseudo-values identify influential observations
</Figure>
...
#> Bootstrap vs Jackknife Standard Errors:
cat("=======================================\n")
#> =======================================
print(se_comparison[, .(Statistic,
                         Bootstrap_SE = round(Bootstrap_SE, 4),
                         Jackknife_SE = round(Jackknife_SE, 4))])
#>          Statistic Bootstrap_SE Jackknife_SE
#>             <char>        <num>        <num>
#> 1:            Mean       0.1519       0.1477
#> 2:          Median       0.1600       0.2382
#> 3:    Trimmed Mean       0.1557       0.1541
#> 4:              SD       0.1255       0.1249
#> 5:             MAD       0.1701       0.2051
#> 6: 25th Percentile       0.1087       0.1032
...
<Figure src="/courses/statistics-3-advanced/method_comparison-1.png" alt="SE estimates from bootstrap vs jackknife">
	SE estimates from bootstrap vs jackknife
</Figure>
...
#> Jackknife for Median (Non-Smooth Statistic):
cat("============================================\n")
#> ============================================
cat("  True SE (simulation):", round(true_se_median, 4), "\n")
#>   True SE (simulation): 0.2131
...
#> Comparison with Mean (Smooth Statistic):
cat("========================================\n")
#> ========================================
...
#>   Significant (raw p < 0.05): 13
cat("  Significant (perm p < 0.05):", sum(p_adj < 0.05), "\n")
#>   Significant (perm p < 0.05): 2
...
<Figure src="/courses/statistics-3-advanced/permutation_multiple_testing-1.png" alt="Permutation-based FDR control in multiple testing">
	Permutation-based FDR control in multiple testing
</Figure>
...
<Figure src="/courses/statistics-3-advanced/block_bootstrap-1.png" alt="Block bootstrap for time series data">
