...
<Figure src="/courses/statistics-3-advanced/ensemble_variance-1.png" alt="Averaging multiple predictions reduces variance—the ensemble (thick line) is smoother than individual trees (thin lines)">
	Averaging multiple predictions reduces variance—the ensemble (thick line) is smoother than individual trees (thin lines)
</Figure>
...
#> 
#> Call:
#>  randomForest(x = X_train, y = y_train, ntree = 500, mtry = 3,      nodesize = 5, importance = TRUE, keep.forest = TRUE) 
...
#> Benign       233        12  0.04897959
#> Malignant     14       139  0.09150327
```
...
<Figure src="/courses/statistics-3-advanced/oob_error-1.png" alt="OOB error stabilises as more trees are added">
	OOB error stabilises as more trees are added
</Figure>
...
<Figure src="/courses/statistics-3-advanced/tune_mtry-1.png" alt="OOB error vs mtry—optimal is often near sqrt(p)">
	OOB error vs mtry—optimal is often near sqrt(p)
</Figure>

```
#> Optimal mtry: 7 
#> Default mtry (sqrt(p)): 3
```
...
<Figure src="/courses/statistics-3-advanced/variable_importance-1.png" alt="Variable importance: permutation-based (left) and Gini-based (right)">
	Variable importance: permutation-based (left) and Gini-based (right)
</Figure>
...
<Figure src="/courses/statistics-3-advanced/partial_dependence-1.png" alt="Partial dependence plots show marginal effect of top features">
	Partial dependence plots show marginal effect of top features
</Figure>
...
<Figure src="/courses/statistics-3-advanced/rf_roc-1.png" alt="Random forest ROC curve shows excellent discriminative performance">
	Random forest ROC curve shows excellent discriminative performance
</Figure>
...
<Figure src="/courses/statistics-3-advanced/proximity-1.png" alt="MDS visualisation of random forest proximity—observations in same terminal nodes are similar">
	MDS visualisation of random forest proximity—observations in same terminal nodes are similar
</Figure>
...
<Figure src="/courses/statistics-3-advanced/tree_vs_rf-1.png" alt="Random forest achieves higher and more stable accuracy than single tree">
	Random forest achieves higher and more stable accuracy than single tree
</Figure>

```
#>            model mean_accuracy sd_accuracy min_accuracy max_accuracy
#>           <char>         <num>       <num>        <num>        <num>
#> 1: Decision Tree     0.9097076  0.01842328    0.8654971    0.9649123
#> 2: Random Forest     0.9367251  0.01914885    0.8947368    0.9766082
```
