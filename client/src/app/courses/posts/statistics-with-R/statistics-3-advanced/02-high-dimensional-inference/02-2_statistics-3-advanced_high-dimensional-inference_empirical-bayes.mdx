...
<Figure src="/courses/statistics-3-advanced/shrinkage_intro-1.png" alt="Empirical Bayes shrinks extreme estimates toward the overall mean">
	Empirical Bayes shrinks extreme estimates toward the overall mean
</Figure>
...
#> =======================
#>   True tau^2: 0.25 
#>   Estimated tau^2: 0.2948 
#>   Noise variance: 1 
#>   Total observed variance: 1.2948
```
...
<Figure src="/courses/statistics-3-advanced/james_stein-1.png" alt="James-Stein estimation reduces MSE compared to sample means">
	James-Stein estimation reduces MSE compared to sample means
</Figure>

```
#>        k   mse_mle    mse_js improvement
#>    <num>     <num>     <num>       <num>
#> 1:     3 1.0113503 0.7846327   0.2241731
#> 2:     5 0.9897399 0.6601935   0.3329626
#> 3:    10 1.0261495 0.5965706   0.4186319
#> 4:    20 1.0022561 0.5479598   0.4532736
#> 5:    50 1.0058921 0.5205683   0.4824810
#> 6:   100 1.0002995 0.5093618   0.4907907
```
...
```
#> Gene-wise Statistics Summary:
#> ============================
#>   Mean true variance: 0.1831 
#>   Mean estimated variance: 0.183
```
...
#> =========================
#>   True d0: 4   Estimated d0: 2.71 
#>   True s0^2: 0.09   Estimated s0^2: 0.0664
```
...
<Figure src="/courses/statistics-3-advanced/variance_shrinkage-1.png" alt="Empirical Bayes shrinks variance estimates toward the prior mean">
	Empirical Bayes shrinks variance estimates toward the prior mean
</Figure>
...
<Figure src="/courses/statistics-3-advanced/limma_performance-1.png" alt="Moderated t-test achieves higher power than classical t-test">
	Moderated t-test achieves higher power than classical t-test
</Figure>

```
#>    threshold    method rejections true_positives false_positives power
#>        <num>    <char>      <int>          <int>           <int> <num>
#> 1:      0.01 Classical        138            135               3 0.270
#> 2:      0.01 Moderated        205            203               2 0.406
#> 3:      0.05 Classical        231            218              13 0.436
#> 4:      0.05 Moderated        264            255               9 0.510
#> 5:      0.10 Classical        275            247              28 0.494
#> 6:      0.10 Moderated        321            284              37 0.568
#>            FDP
#>          <num>
#> 1: 0.021739130
#> 2: 0.009756098
...
<Figure src="/courses/statistics-3-advanced/sample_size_effect-1.png" alt="Empirical Bayes helps most with small sample sizes">
	Empirical Bayes helps most with small sample sizes
</Figure>
...
<Figure src="/courses/statistics-3-advanced/pi0_estimation-1.png" alt="Estimating the null proportion from p-value histogram">
	Estimating the null proportion from p-value histogram
</Figure>
...
```
#> Comparison: Manual vs limma Implementation:
#> ==========================================
#>   Correlation of t-statistics: 0.9977 
#>   Correlation of p-values: 0.9978
```
...
<Figure src="/courses/statistics-3-advanced/limma_volcano-1.png" alt="Volcano plot from limma analysis">
	Volcano plot from limma analysis
</Figure>
