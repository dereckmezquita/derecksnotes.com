...
<Figure src="/courses/statistics-3-advanced/multiple_testing_sim-1.png" alt="False positive rate explodes as the number of tests increases">
	False positive rate explodes as the number of tests increases
</Figure>
...
<Figure src="/courses/statistics-3-advanced/bonferroni_visual-1.png" alt="Bonferroni correction is extremely conservative&lt;U+2014&gt;most true signals are missed">
	Bonferroni correction is extremely conservative&lt;U+2014&gt;most true signals are missed
</Figure>
...
#>   Bonferroni threshold: 5e-06
cat("  Šidák threshold:     ", sidak_threshold, "\n")
#>   <U+0160>id<U+00E1>k threshold:      5.129316e-06
cat("  Ratio (Šidák/Bonf):  ", sidak_threshold / bonferroni_threshold, "\n")
#>   Ratio (<U+0160>id<U+00E1>k/Bonf):   1.025863
```
...
<Figure src="/courses/statistics-3-advanced/bh_procedure-1.png" alt="Benjamini-Hochberg procedure: reject p-values below the diagonal line">
	Benjamini-Hochberg procedure: reject p-values below the diagonal line
</Figure>
...
print(comparison)
#>         Method Threshold_Type Rejections True_Positives False_Positives   FDP
#>         <char>         <char>      <int>          <int>           <int> <num>
#> 1: Uncorrected     FWER naive        786            340             446 0.567
#> 2:  Bonferroni           FWER          5              5               0 0.000
#> 3:        Holm           FWER          5              5               0 0.000
#> 4:    BH (FDR)            FDR         15             15               0 0.000
#>    Power
#>    <num>
#> 1:  0.68
#> 2:  0.01
...
<Figure src="/courses/statistics-3-advanced/power_fdr_tradeoff-1.png" alt="Power vs error control: FDR methods achieve high power with acceptable error rates">
	Power vs error control: FDR methods achieve high power with acceptable error rates
</Figure>
...
<Figure src="/courses/statistics-3-advanced/signal_strength_sim-1.png" alt="FDR control adapts to signal strength better than FWER methods">
	FDR control adapts to signal strength better than FWER methods
</Figure>
...
<Figure src="/courses/statistics-3-advanced/lfdr_illustration-1.png" alt="Local FDR: probability a specific result is a false discovery">
	Local FDR: probability a specific result is a false discovery
</Figure>
...
<Figure src="/courses/statistics-3-advanced/lfdr_curve-1.png" alt="Local FDR as a function of z-score: large z-scores have low lfdr">
	Local FDR as a function of z-score: large z-scores have low lfdr
</Figure>
...
#> True DE genes: 350 ( 198 up, 152 down)
```
...
<Figure src="/courses/statistics-3-advanced/volcano_plot-1.png" alt="Volcano plot with FDR-significant genes highlighted">
	Volcano plot with FDR-significant genes highlighted
</Figure>
...
#>                    Method rejections    TP    FP     power       FDP
#>                    <char>      <int> <int> <int>     <num>     <num>
#> 1: Uncorrected (p < 0.05)        930   192   738 0.5485714 0.7935484
#> 2:             Bonferroni          0     0     0 0.0000000 0.0000000
#> 3:                   Holm          0     0     0 0.0000000 0.0000000
#> 4:          BH (q < 0.05)          0     0     0 0.0000000 0.0000000
```
