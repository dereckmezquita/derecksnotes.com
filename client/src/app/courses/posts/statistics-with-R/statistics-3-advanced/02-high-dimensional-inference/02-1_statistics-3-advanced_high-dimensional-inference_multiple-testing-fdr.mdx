...
<Figure src="/courses/statistics-3-advanced/bonferroni_visual-1.png" alt="Bonferroni correction is extremely conservative—most true signals are missed">
	Bonferroni correction is extremely conservative—most true signals are missed
</Figure>
