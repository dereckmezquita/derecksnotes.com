...
#> Ridge Regression (L2):
cat("  - Penalty: λ Σ β²\n")
#>   - Penalty: <U+03BB> <U+03A3> <U+03B2><U+00B2>
...
#>   - Penalty: <U+03BB>[(1-<U+03B1>)<U+03A3><U+03B2><U+00B2> + <U+03B1><U+03A3>|<U+03B2>|]
