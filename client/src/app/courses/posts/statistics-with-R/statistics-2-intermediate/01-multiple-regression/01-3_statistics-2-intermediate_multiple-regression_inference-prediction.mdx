...
#> Estimated <U+03C3><U+00B2> (s<U+00B2>): 235.6765
cat("Estimated σ (s):", round(s, 4), "\n")
#> Estimated <U+03C3> (s): 15.3518
...
#> 
#> Note: R<U+00B2> increased when adding 'Random' but Adjusted R<U+00B2> decreased,
...
<Figure src="/courses/statistics-2-intermediate/r_squared-1.png" alt="R&lt;U+00B2&gt; vs Adjusted R&lt;U+00B2&gt; as predictors are added">
	R&lt;U+00B2&gt; vs Adjusted R&lt;U+00B2&gt; as predictors are added
</Figure>
