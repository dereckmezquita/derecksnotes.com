...
```{r simulate_trial, fig.cap="Simulated multi-site trial with varying hospital effects"}
...
```{r glmm_diagnostics, fig.cap="Diagnostic plots for GLMMs"}
# For logistic GLMM
...
```{r re_diagnostics, fig.cap="Q-Q plot for random effects should show normality"}
...
```{r nhanes_glmm, fig.cap="Diabetes risk varies across age groups (simulated clustering)"}
