...
<Figure src="/courses/statistics-2-intermediate/kmeans_iteration-1.png" alt="K-means iteratively assigns points to nearest centroid and updates centres">
	K-means iteratively assigns points to nearest centroid and updates centres
</Figure>
...
<Figure src="/courses/statistics-2-intermediate/elbow_silhouette-1.png" alt="Elbow and silhouette methods help choose optimal number of clusters">
	Elbow and silhouette methods help choose optimal number of clusters
</Figure>
...
<Figure src="/courses/statistics-2-intermediate/kmeans_breast_cancer-1.png" alt="K-means clustering of breast cancer tumours">
	K-means clustering of breast cancer tumours
</Figure>
...
#> =================================
#> 
#> Cluster sizes: 169 400 
#> 
#> Comparison with actual diagnosis:
#>        Diagnosis
#> Cluster   B   M
#>       1   6 163
#>       2 351  49
#> 
#> Agreement with diagnosis: 90.3%
```
...
<Figure src="/courses/statistics-2-intermediate/hierarchical_linkage-1.png" alt="Different linkage methods produce different cluster structures">
...
<Figure src="/courses/statistics-2-intermediate/dendrogram_cut-1.png" alt="Dendrograms show cluster hierarchy; horizontal cut defines number of clusters">
	Dendrograms show cluster hierarchy; horizontal cut defines number of clusters
</Figure>
...
<Figure src="/courses/statistics-2-intermediate/clustering_comparison-1.png" alt="Different clustering methods may produce different groupings">
	Different clustering methods may produce different groupings
</Figure>
...
#> Clustering Method Agreement:
#> ============================
#>   K-means vs Hierarchical: ARI = 0.619
#>   K-means vs Model-based: ARI = 0.630
#>   Hierarchical vs Model-based: ARI = 0.599
```
...
<Figure src="/courses/statistics-2-intermediate/gmm_demo-1.png" alt="Model-based clustering provides probability of cluster membership">
	Model-based clustering provides probability of cluster membership
</Figure>
...
#> 
#> Model selected: VVV 
#>   (Covariance structure - see mclust documentation)
#> 
#> Cluster membership uncertainty:
#>   Mean: 0.015 
#>   Observations with >20% uncertainty: 14
```
...
<Figure src="/courses/statistics-2-intermediate/gmm_bic-1.png" alt="BIC helps select both the number of clusters and covariance structure">
	BIC helps select both the number of clusters and covariance structure
</Figure>
...
#> Best BIC values:
#>              VVV,5       VVV,4      VVV,6
#> BIC      -2558.921 -2566.98752 -2849.7140
#> BIC diff     0.000    -8.06667  -290.7931
```
...
<Figure src="/courses/statistics-2-intermediate/lda_fit-1.png" alt="LDA finds the direction that best separates groups">
	LDA finds the direction that best separates groups
</Figure>
...
#> B      12.147       17.915         78.075   462.790           0.092
#> M      17.463       21.605        115.365   978.376           0.103
#> 
#> Coefficients of linear discriminants:
#>                           LD1
#> mean_radius             2.174
#> mean_texture            0.097
#> mean_perimeter         -0.244
#> mean_area              -0.004
#> mean_smoothness         8.610
#> mean_compactness        0.431
#> mean_concavity          3.592
#> mean_concave_points    28.530
#> mean_symmetry           4.489
#> mean_fractal_dimension -0.529
```
...
#> Performance Metrics:
#>   Accuracy: 93.8%
#>   Sensitivity (TPR): 86.3%
#>   Specificity (TNR): 98.3%
#>   Precision (PPV): 96.8%
```
...
<Figure src="/courses/statistics-2-intermediate/decision_boundaries-1.png" alt="LDA produces linear boundaries; QDA produces quadratic boundaries">
	LDA produces linear boundaries; QDA produces quadratic boundaries
</Figure>
...
<Figure src="/courses/statistics-2-intermediate/publication_summary-1.png" alt="Classification performance summary for clinical communication">
	Classification performance summary for clinical communication
</Figure>
