...
<Figure src="/courses/statistics-2-intermediate/monte_carlo_demo-1.png" alt="Monte Carlo estimation: sample mean converges to true posterior mean">
	Monte Carlo estimation: sample mean converges to true posterior mean
</Figure>
...
#>    Samples Est. Mean MC Std. Error Theoretical SE
#>      <num>     <num>         <num>          <num>
#> 1:      10    0.6579        0.0247         0.0250
#> 2:      50    0.6568        0.0109         0.0112
#> 3:     100    0.6571        0.0081         0.0079
#> 4:     500    0.6572        0.0035         0.0035
#> 5:    1000    0.6572        0.0025         0.0025
#> 6:    5000    0.6572        0.0011         0.0011
...
<Figure src="/courses/statistics-2-intermediate/mc_accuracy-1.png" alt="Monte Carlo standard error decreases with more samples">
	Monte Carlo standard error decreases with more samples
</Figure>
...
<Figure src="/courses/statistics-2-intermediate/metropolis_implementation-1.png" alt="Metropolis algorithm sampling from a Beta posterior">
	Metropolis algorithm sampling from a Beta posterior
</Figure>
...
<Figure src="/courses/statistics-2-intermediate/proposal_scale-1.png" alt="Effect of proposal standard deviation on chain mixing">
	Effect of proposal standard deviation on chain mixing
</Figure>
...
<Figure src="/courses/statistics-2-intermediate/mcmc_diagnostics-1.png" alt="MCMC diagnostics: trace, autocorrelation, and effective sample size">
	MCMC diagnostics: trace, autocorrelation, and effective sample size
</Figure>
...
#> Interpretation: Chains have NOT converged - run longer
...
<Figure src="/courses/statistics-2-intermediate/multiple_chains-1.png" alt="Multiple chains from different starting points should converge">
	Multiple chains from different starting points should converge
</Figure>
...
#> Bayesian Regression MCMC Results:
cat("==================================\n\n")
#> ==================================
...
#>   beta0: Mean = 99.145, SD = 2.195, 95% CI = [94.534, 104.005]
#>   beta1: Mean = 0.508, SD = 0.042, 95% CI = [0.417, 0.594]
#>   sigma: Mean = 4.612, SD = 0.331, 95% CI = [3.951, 5.251]

cat("\nTrue values: β₀ =", beta0_true, ", β₁ =", beta1_true, ", σ =", sigma_true, "\n")
#> 
#> True values: <U+03B2><U+2080> = 100 , <U+03B2><U+2081> = 0.5 , <U+03C3> = 5
```
...
<Figure src="/courses/statistics-2-intermediate/regression_trace_plots-1.png" alt="Trace plots for Bayesian regression parameters">
	Trace plots for Bayesian regression parameters
</Figure>
...
<Figure src="/courses/statistics-2-intermediate/regression_posterior_pairs-1.png" alt="Joint posterior distribution shows parameter correlations">
	Joint posterior distribution shows parameter correlations
</Figure>
...
<Figure src="/courses/statistics-2-intermediate/posterior_predictive-1.png" alt="Posterior predictive distribution includes both parameter and residual uncertainty">
	Posterior predictive distribution includes both parameter and residual uncertainty
</Figure>
