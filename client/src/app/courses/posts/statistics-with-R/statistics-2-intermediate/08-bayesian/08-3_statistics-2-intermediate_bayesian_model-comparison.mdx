...
#> BF<U+2081><U+2080> (effect vs no effect): 54
cat("BF₀₁ (no effect vs effect):", round(bf_01, 2), "\n")
#> BF<U+2080><U+2081> (no effect vs effect): 0.02
cat("\nInterpretation: ")
#> 
#> Interpretation:
if (bf_10 > 10) {
...
#> Strong evidence for treatment effect
...
<Figure src="/courses/statistics-2-intermediate/bayes_factor_concept-1.png" alt="Bayes factor measures relative evidence for two models">
	Bayes factor measures relative evidence for two models
</Figure>
...
#> BayesFactor package not installed.
#> Install with: install.packages('BayesFactor')
```
...
<Figure src="/courses/statistics-2-intermediate/prior_sensitivity_bf-1.png" alt="Bayes factor sensitivity to prior width">
	Bayes factor sensitivity to prior width
</Figure>
...
#> 1: Intercept only     2 238.2      10.0  0.005
#> 2:         Linear     3 231.3       3.1  0.154
#> 3:      Quadratic     4 228.2       0.0  0.733
#> 4:       Degree 5     7 232.0       3.8  0.108
...
<Figure src="/courses/statistics-2-intermediate/waic_concept-1.png" alt="WAIC balances model fit and complexity">
	WAIC balances model fit and complexity
</Figure>
...
<Figure src="/courses/statistics-2-intermediate/model_averaging-1.png" alt="Model-averaged predictions incorporate model uncertainty">
...
#>   Posterior mean effect: -13.5 mmHg
...
<Figure src="/courses/statistics-2-intermediate/clinical_trial_bayesian-1.png" alt="Complete Bayesian analysis of clinical trial data">
	Complete Bayesian analysis of clinical trial data
</Figure>
...
#>        n Obs. Effect Post. Mean        95% CI P(effective)
#>    <num>       <num>      <num>        <char>        <num>
#> 1:    25         NaN         NA      [NA, NA]           NA
#> 2:    50         NaN         NA      [NA, NA]           NA
#> 3:    75       -10.4      -10.2 [-15.9, -4.6]         96.6
#> 4:   100        -8.3       -8.7   [-13.4, -4]         93.8

cat("\nDecision rules:\n")
#> 
#> Decision rules:
cat("  Stop for efficacy if P(effect < -5) > 0.95\n")
#>   Stop for efficacy if P(effect < -5) > 0.95
cat("  Stop for futility if P(effect > 0) > 0.90\n")
#>   Stop for futility if P(effect > 0) > 0.90
...
<Figure src="/courses/statistics-2-intermediate/adaptive_trial-1.png" alt="Sequential Bayesian updating in an adaptive trial">
	Sequential Bayesian updating in an adaptive trial
</Figure>
