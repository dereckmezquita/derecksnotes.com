...
#> 
#> Dispersion parameter <U+03B8>: 1.053
cat("(Larger θ = less overdispersion; θ → ∞ approaches Poisson)\n")
#> (Larger <U+03B8> = less overdispersion; <U+03B8> <U+2192> <U+221E> approaches Poisson)
```
...
#>   Note: Testing <U+03B8> at boundary (null is Poisson), so use mixture chi-square
...
#>    <U+2022> NO  <U+2192> Poisson may be adequate
cat("   • YES → Consider Negative Binomial\n")
#>    <U+2022> YES <U+2192> Consider Negative Binomial
cat("   ↓\n")
#>    <U+2193>
...
#>    <U+2022> NO  <U+2192> NegBin may be adequate
cat("   • YES → Consider Zero-Inflated model (ZINB)\n")
#>    <U+2022> YES <U+2192> Consider Zero-Inflated model (ZINB)
cat("   ↓\n")
#>    <U+2193>
...
#>   <U+2022> MASS: glm.nb() for negative binomial
cat("  • pscl: zeroinfl() and hurdle() for zero-inflated/hurdle models\n")
#>   <U+2022> pscl: zeroinfl() and hurdle() for zero-inflated/hurdle models
```
...
#>   <U+2022> Hurdle: When zeros represent 'no participation'
...
#>   <U+2022> Zero-inflated: When zeros are a mix of types
