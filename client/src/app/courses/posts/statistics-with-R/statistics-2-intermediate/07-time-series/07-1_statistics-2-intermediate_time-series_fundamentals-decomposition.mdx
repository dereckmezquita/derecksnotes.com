...
<Figure src="/courses/statistics-2-intermediate/components_illustration-1.png" alt="The four components of a time series">
...
<Figure src="/courses/statistics-2-intermediate/trend_component-1.png" alt="The trend represents long-term direction">
...
<Figure src="/courses/statistics-2-intermediate/seasonal_component-1.png" alt="Seasonality shows regular periodic patterns">
...
<Figure src="/courses/statistics-2-intermediate/noise_component-1.png" alt="Irregular noise is the unexplained variation">
...
<Figure src="/courses/statistics-2-intermediate/time_plot-1.png" alt="US accidental deaths show strong seasonal pattern">
...
<Figure src="/courses/statistics-2-intermediate/seasonal_plot-1.png" alt="Seasonal plot reveals peak deaths in summer months">
...
<Figure src="/courses/statistics-2-intermediate/subseries_plot-1.png" alt="Subseries plot shows both seasonal pattern and yearly trends">
...
<Figure src="/courses/statistics-2-intermediate/acf_calculation-1.png" alt="ACF reveals the autocorrelation structure of the series">
...
<Figure src="/courses/statistics-2-intermediate/pacf_calculation-1.png" alt="PACF shows direct effects at each lag">
...
<Figure src="/courses/statistics-2-intermediate/moving_average-1.png" alt="Moving average extracts the trend from noisy data">
...
<Figure src="/courses/statistics-2-intermediate/additive_decomposition-1.png" alt="Additive decomposition separates trend, seasonal, and remainder">
...
<Figure src="/courses/statistics-2-intermediate/decomp_trend-1.png" alt="Trend component shows overall level changes">
...
<Figure src="/courses/statistics-2-intermediate/decomp_seasonal-1.png" alt="Seasonal component repeats each year">
...
<Figure src="/courses/statistics-2-intermediate/decomp_remainder-1.png" alt="Remainder is what&#39;s left after removing trend and seasonal">
...
<Figure src="/courses/statistics-2-intermediate/stl_plot-1.png" alt="STL provides smooth trend and consistent seasonal estimates">
...
<Figure src="/courses/statistics-2-intermediate/seasonal_adjustment-1.png" alt="Seasonally adjusted series reveals the underlying trend">
...
<Figure src="/courses/statistics-2-intermediate/influenza_analysis-1.png" alt="Influenza surveillance data shows strong seasonal epidemic pattern">
	Influenza surveillance data shows strong seasonal epidemic pattern
</Figure>
...
<Figure src="/courses/statistics-2-intermediate/flu_acf-1.png" alt="Influenza ACF shows strong annual seasonality">
	Influenza ACF shows strong annual seasonality
</Figure>
