...
#> KEY FINDINGS:
#> • Expected average: 9137 deaths/month (range: 7163-11482)
#> • Peak expected: Month 7 with ~10819 deaths
#> • Low expected: Month 2 with ~7599 deaths
#> 
#> MODEL INFORMATION:
#> • Model type: ETS (ETS(A,N,A))
#> • Data through: December 1978
#> • Forecast horizon: 12 months
#> • Historical accuracy: MAPE =  2.3 %
#> 
#> RECOMMENDATIONS:
