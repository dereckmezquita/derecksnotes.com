...
<Figure src="/courses/statistics-2-intermediate/ses_demo-1.png" alt="Simple exponential smoothing with different smoothing parameters">
	Simple exponential smoothing with different smoothing parameters
</Figure>
...
#>   Level smoothing (<U+03B1>): 0.747 
#>   Trend smoothing (<U+03B2>): 0
```
...
#> Holt-Winters Model Comparison:
#> ==============================
#> 
#> Additive:       AIC = 1145.8 
#> Multiplicative: AIC = 1153.3 
#> 
#> Better model: Additive
```

<Figure src="/courses/statistics-2-intermediate/hw_demo-1.png" alt="Holt-Winters method captures trend and seasonal patterns in mortality data">
	Holt-Winters method captures trend and seasonal patterns in mortality data
</Figure>
...
<Figure src="/courses/statistics-2-intermediate/ets_taxonomy-1.png" alt="The ETS model taxonomy covers all exponential smoothing variants">
	The ETS model taxonomy covers all exponential smoothing variants
</Figure>
...
<Figure src="/courses/statistics-2-intermediate/ets_auto-1.png" alt="ETS automatically selects the best model based on AIC">
	ETS automatically selects the best model based on AIC
</Figure>
...
<Figure src="/courses/statistics-2-intermediate/tscv_illustration-1.png" alt="Time series cross-validation respects temporal ordering">
...
#> Forecast Accuracy Comparison (Test Set):
#> =========================================
#> 
#>           Model     RMSE      MAE     MAPE      MASE
#>          <char>    <num>    <num>    <num>     <num>
#> 1:          ETS 381.1718 297.4217 3.234103 0.5872372
#> 2:        ARIMA 575.4261 474.5192 5.198646 0.9369032
#> 3: Holt-Winters 694.0991 589.4149 6.513567 1.1637563
```
...
<Figure src="/courses/statistics-2-intermediate/forecast_comparison-1.png" alt="Comparing forecasts from different methods against actual values">
	Comparing forecasts from different methods against actual values
</Figure>
...
<Figure src="/courses/statistics-2-intermediate/prediction_intervals-1.png" alt="Prediction intervals widen as forecast horizon increases">
	Prediction intervals widen as forecast horizon increases
</Figure>
...
<Figure src="/courses/statistics-2-intermediate/combined_forecast-1.png" alt="Combined forecast often outperforms individual models">
	Combined forecast often outperforms individual models
</Figure>
...
#> Outlier Detection in Influenza Data:
cat("=====================================\n")
#> =====================================
...
#> Outlier weeks:
#>        time cases remainder
#>        <ts> <num>     <num>
#> 1: 2006.154    44 -340.1972
#> 2: 2007.115   768  409.8031
#> 3: 2007.135   927  497.9794
#> 4: 2007.154  1158  667.5306
#> 5: 2007.173   981  556.9332
#> 6: 2007.192   657  307.4608
#> 7: 2008.058   591  400.2368
#> 8: 2008.077   731  487.9823
...
<Figure src="/courses/statistics-2-intermediate/special_events-1.png" alt="Detecting and handling outliers in time series">
	Detecting and handling outliers in time series
</Figure>
...
#> ================================
#> 
#> Training period: 2001-2006 ( 312 weeks)
#> Test period: 2007-2008 ( 104 weeks)
#> Selected Models:
#>   ARIMA: 4,0,0,0,0,0,52 
#>   ETS: ETS(A,Ad,N) 
#> 
#> Test Set Accuracy:
#> ------------------
#> ARIMA:    RMSE = 264.1, MAE = 125.1
#> ETS:      RMSE = 278.0, MAE = 123.2
#> Combined: RMSE = 270.5, MAE = 119.0
```

<Figure src="/courses/statistics-2-intermediate/flu_comprehensive-1.png" alt="Comprehensive influenza forecasting analysis">
	Comprehensive influenza forecasting analysis
</Figure>
...
<Figure src="/courses/statistics-2-intermediate/stakeholder_presentation-1.png" alt="Forecast presentation for stakeholders with clear uncertainty bands">
	Forecast presentation for stakeholders with clear uncertainty bands
</Figure>
...
#>     MONTHLY MORTALITY FORECAST REPORT
cat("========================================\n\n")
#> ========================================
...
#> Based on analysis of historical patterns, we forecast continued
cat("seasonal variation in accidental deaths over the next 12 months.\n\n")
#> seasonal variation in accidental deaths over the next 12 months.
...
#> KEY FINDINGS:
#> <U+2022> Expected average: 9137 deaths/month (range: 7163-11482)
#> <U+2022> Peak expected: Month 7 with ~10819 deaths
#> <U+2022> Low expected: Month 2 with ~7599 deaths
#> 
#> MODEL INFORMATION:
#> <U+2022> Model type: ETS (ETS(A,N,A))
#> <U+2022> Data through: December 1978
#> <U+2022> Forecast horizon: 12 months
#> <U+2022> Historical accuracy: MAPE =  2.3 %
#> 
#> RECOMMENDATIONS:
#> 1. Plan for 15-20% higher resource needs during summer months
#> 2. Review forecasts monthly and adjust as new data arrive
#> 3. Consider additional factors not captured in this model
#>    (policy changes, demographic shifts, etc.)
```
