...
#> Bonferroni-corrected critical value (<U+03B1> = 0.05): 4.497
...
#> High leverage threshold (2<U+00D7> average): 0.00112
...
#> Threshold: 2<U+221A>((p+1)/n) = 0.0473
...
#>    <U+2192> Heteroscedasticity: standard errors are unreliable
...
#>    <U+2192> Non-normality: inference may be affected
...
#>    <U+2192> Consider: log transformation, Poisson/negative binomial regression
```
