...
#>   → Patients differ by about ± 8 CD4 cells at baseline

cat("Residual SD (σ):", round(sigma_residual, 2), "\n")
#> Residual SD (σ): 2.12
cat("  → Within-patient variation around their trajectory\n\n")
#>   → Within-patient variation around their trajectory
...
#>   →  79.9 % of total variance is between patients
cat("  → ", round(100*(1-icc), 1), "% of variance is within patients over time\n\n")
#>   →  20.1 % of variance is within patients over time
