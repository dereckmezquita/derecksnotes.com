...
#> This variation suggests slopes should be random, not fixed.
...
<Figure src="/courses/statistics-2-intermediate/varying_slopes-1.png" alt="Different patients have different trajectories over time">
	Different patients have different trajectories over time
</Figure>
...
#> Random Slope Model: CD4 ~ Time + (Time | patient)
cat("=======================================================\n\n")
#> =======================================================
summary(model_rs)
#> Linear mixed model fit by REML. t-tests use Satterthwaite's method [
#> lmerModLmerTest]
#> Formula: CD4 ~ Time + (Time | patient)
#>    Data: cd4_data
#> 
#> REML criterion at convergence: 7259.7
#> 
#> Scaled residuals: 
#>     Min      1Q  Median      3Q     Max 
#> -3.6208 -0.4581 -0.0389  0.4616  5.1062 
#> 
#> Random effects:
#>  Groups   Name        Variance Std.Dev. Corr 
#>  patient  (Intercept) 12.45873 3.5297        
#>           Time         0.06123 0.2474   -0.27
#>  Residual              4.52712 2.1277        
#> Number of obs: 1405, groups:  patient, 467
#> 
#> Fixed effects:
#>              Estimate Std. Error        df t value Pr(>|t|)    
#> (Intercept)   3.32724    0.51994 146.09977   6.399 1.99e-09 ***
#> Time          0.26132    0.04073 226.97044   6.415 8.08e-10 ***
#> ---
...
#> Model failed to converge with max|grad| = 0.00454177 (tol = 0.002, component 1)
...
#> Interpreting Random Slope Model:
cat("================================\n\n")
#> ================================
...
#>     <U+2192> Patients with higher baselines tend to have smaller increases (regression to mean)
...
#> Data: cd4_data
#> Models:
#> model_ri: CD4 ~ Time + (1 | patient)
#> model_rs: CD4 ~ Time + (Time | patient)
#>          npar    AIC    BIC  logLik -2*log(L)  Chisq Df Pr(>Chisq)  
#> model_ri    4 7271.0 7292.0 -3631.5    7263.0                       
#> model_rs    6 7265.8 7297.3 -3626.9    7253.8 9.1985  2    0.01006 *
#> ---
#> Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
...
#> CONCLUSION: Random slope model significantly improves fit.
```
...
<Figure src="/courses/statistics-2-intermediate/visualise_random_effects-1.png" alt="Distribution of random intercepts and slopes">
	Distribution of random intercepts and slopes
</Figure>
...
<Figure src="/courses/statistics-2-intermediate/patient_trajectories-1.png" alt="Patient-specific predicted trajectories">
	Patient-specific predicted trajectories
</Figure>
...
#>    Include all random effects that the design supports
cat("   (intercepts and slopes for all grouping factors)\n\n")
#>    (intercepts and slopes for all grouping factors)
...
#>    - AIC/BIC for general comparison
```
...
#>                          Model    AIC    BIC
#>                         <char>  <num>  <num>
#> 1:            Random intercept 7276.8 7297.8
#> 2:   Random slope (correlated) 7271.7 7303.2
#> 3: Random slope (uncorrelated) 7270.0 7296.2

cat("\nBest by AIC:", model_compare[which.min(AIC), Model], "\n")
#> 
#> Best by AIC: Random slope (uncorrelated)
cat("Best by BIC:", model_compare[which.min(BIC), Model], "\n")
#> Best by BIC: Random slope (uncorrelated)
```
