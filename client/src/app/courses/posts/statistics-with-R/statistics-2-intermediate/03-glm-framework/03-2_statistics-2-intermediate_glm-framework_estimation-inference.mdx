...
#>   <U+03B2><U+2080> = -5.0588
cat("  β₁ =", round(mle_beta[2], 5), "\n")
#>   <U+03B2><U+2081> = 0.05419
...
#> Pearson <U+03C7><U+00B2>: 34872.24
cat("df:", df_residual, "\n")
#> df: 4404
cat("Estimated dispersion (φ):", round(dispersion_est, 3), "\n")
#> Estimated dispersion (<U+03C6>): 7.918
cat("\nInterpretation:\n")
#> 
#> Interpretation:
...
#>   <U+03C6> >> 1 indicates substantial overdispersion.
...
#> 
#> Note: Quasipoisson SEs are <U+221A><U+03C6> times larger.
```
