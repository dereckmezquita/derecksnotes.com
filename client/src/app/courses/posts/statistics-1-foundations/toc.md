...
- **`02.3_statistics-1-foundations_descriptive-numerical_shape-grouped-outliers.Rmd`**
    ...
    - **Communicating to Stakeholders:** Creating summary tables for clinical reports and explaining outlier decisions.
    - **Quick Reference:** Shape measures, grouped statistics, and outlier detection methods.
...
- **`03.3_statistics-1-foundations_visualisation_qq-timeseries-advanced.Rmd`**
    ...
    - **Quick Reference:** QQ plot interpretation, time series syntax, and export settings.
...
- **`04.3_statistics-1-foundations_probability_counting-simulation.Rmd`**
    ...
    - **Communicating to Stakeholders:** Using simulation to explain probability concepts intuitively.
    - **Quick Reference:** Counting formulae and Monte Carlo simulation patterns.
...
- **`05.4_statistics-1-foundations_distributions_exponential-gamma-beta-related.Rmd`**
    ...
    - **Communicating to Stakeholders:** Explaining distribution choice and what it means practically.
    - **Quick Reference:** Distribution summary table with formulae, properties, and R functions.
...
- **`06.2_statistics-1-foundations_sampling-distributions_proportion-variance-t.Rmd`**
    ...
    - **Communicating to Stakeholders:** Explaining why larger studies are more reliable and what "margin of error" means.
    - **Quick Reference:** Proportion, variance, and t-distribution sampling formulae.
...
- **`07.2_statistics-1-foundations_estimation_mle-comparison-robust.Rmd`**
    ...
    - **Communicating to Stakeholders:** Reporting estimates with appropriate precision and uncertainty.
    - **Quick Reference:** MLE formulae, Fisher information, and robust alternatives.
...
- **`08.3_statistics-1-foundations_confidence-intervals_sample-size-bootstrap.Rmd`**
    ...
    - **Communicating to Stakeholders:** Planning studies and explaining sample size requirements.
    - **Quick Reference:** Sample size formulae and bootstrap implementation patterns.
...
- **`09.2_statistics-1-foundations_hypothesis-testing_power-effect-sizes-controversy.Rmd`**
    ...
    - **Communicating to Stakeholders:** Explaining effect sizes and study limitations honestly.
    - **Quick Reference:** Power analysis formulae and effect size interpretation guidelines.
...
- **`10.2_statistics-1-foundations_hypothesis-tests_proportions-variance.Rmd`**
    ...
    - **Quick Reference:** Test selection guide and formulae for proportions and variance.
...
- **`11.2_statistics-1-foundations_chisq-nonparametric_rank-permutation.Rmd`**
    ...
    - **Quick Reference:** Non-parametric test selection guide and R functions.
...
- **`12.3_statistics-1-foundations_regression_diagnostics-transformations.Rmd`**
    ...
    - **Quick Reference:** Diagnostic checklist and transformation interpretation guide.
...
- **`13.2_statistics-1-foundations_anova_posthoc-contrasts-linear.Rmd`**
    ...
    - **Quick Reference:** Post-hoc decision guide and contrast implementation.
...
- **`14.2_statistics-1-foundations_design_power-validity-ethics.Rmd`**
    ...
    - **Quick Reference:** Power analysis formulae and validity threats checklist.
...
- **`15.3_statistics-1-foundations_reproducibility_solutions-best-practices.Rmd`**
    ...
    - **Quick Reference:** Best practices checklist and reproducible workflow template.
