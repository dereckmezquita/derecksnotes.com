...
```{r nonresponse_bias, fig.cap="Non-response bias: respondents differ systematically from non-respondents"}
set.seed(404)
...
```{r measurement_bias, fig.cap="Systematic measurement bias shifts all measurements; larger samples do not correct it"}
set.seed(505)
...
```{r bias_vs_variability, fig.cap="The target diagram: accuracy (bias) vs precision (variability)"}
set.seed(606)
