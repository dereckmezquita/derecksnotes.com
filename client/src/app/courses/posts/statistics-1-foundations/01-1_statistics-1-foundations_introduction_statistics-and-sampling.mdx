...
<Figure src="statistics_essence-1.png" alt="Statistics bridges the gap between sample observations and population truth">
...
<Figure src="descriptive_vs_inferential-1.png" alt="Descriptive statistics summarises data; inferential statistics generalises to populations">
