...
<Figure src="/courses/financial-statistics-1-foundations/rolling-mean-instability-1.png" alt="Rolling 3-year mean returns for S&amp;P 500 show enormous variation, ranging from -20% to +30% annualised. The true expected return is obscured by noise.">
	Rolling 3-year mean returns for S&amp;P 500 show enormous variation, ranging from -20% to +30% annualised. The true expected return is obscured by noise.
</Figure>
...
<Figure src="/courses/financial-statistics-1-foundations/confidence-bands-1.png" alt="95% confidence intervals for expected return remain wide even with 10 years of data. The uncertainty in mean estimation is irreducible with reasonable sample sizes.">
	95% confidence intervals for expected return remain wide even with 10 years of data. The uncertainty in mean estimation is irreducible with reasonable sample sizes.
</Figure>
...
```
S&P 500 Expected Return Estimation:
  Point estimate: 10.18% annualised
  Standard error: 4.16%
  95% CI: [2.03%, 18.32%]
  t-statistic: 2.45 (p = 0.014)
...
<Figure src="/courses/financial-statistics-1-foundations/bootstrap-ci-1.png" alt="Bootstrap distribution of mean return estimates. The wide spread reflects genuine uncertainty in expected returns.">
	Bootstrap distribution of mean return estimates. The wide spread reflects genuine uncertainty in expected returns.
</Figure>
...
<Figure src="/courses/financial-statistics-1-foundations/simulate-trades-1.png" alt="Trade P&amp;L distributions for two strategies with identical expected returns but different win rates. The psychological experience differs dramatically.">
	Trade P&amp;L distributions for two strategies with identical expected returns but different win rates. The psychological experience differs dramatically.
</Figure>
...
<Figure src="/courses/financial-statistics-1-foundations/cumulative-trades-1.png" alt="Cumulative P&amp;L for high vs low win rate strategies. Strategy B (low win rate) has more losing streaks but larger eventual gains.">
	Cumulative P&amp;L for high vs low win rate strategies. Strategy B (low win rate) has more losing streaks but larger eventual gains.
</Figure>
