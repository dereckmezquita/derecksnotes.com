...
![Volatility targeting scales position size inversely with volatility, maintaining consistent risk exposure through different market regimes.](/courses/financial-statistics-1-foundations/../figures/05-2_vol-targeting-concept-1.png)
...
![Vol-targeted strategy achieves similar total return with dramatically reduced peak-to-trough drawdowns and more consistent risk exposure.](/courses/financial-statistics-1-foundations/../figures/05-2_vol-targeting-performance-1.png)
...
![Vol targeting position sizes during different market regimes. The 2020 COVID crash shows automatic deleveraging.](/courses/financial-statistics-1-foundations/../figures/05-2_vol-target-regimes-1.png)
...
![True Range captures gaps that standard deviation misses. ATR smooths True Range over time to give a stable volatility estimate.](/courses/financial-statistics-1-foundations/../figures/05-2_atr-calculation-1.png)
...
![ATR-based position sizing: number of shares to trade so that 1 ATR move equals a fixed dollar risk amount.](/courses/financial-statistics-1-foundations/../figures/05-2_atr-position-sizing-1.png)
...
```
## $100,000 account, 1% risk per trade, 2-ATR stop
```
...
```
##    Ticker   Price    ATR  ATR % Shares Weight
##    <char>  <char> <char> <char> <char> <char>
## 1:    SPY $463.84 $14.38   3.1%     35  16.1%
## 2:    QQQ $405.05  $7.74   1.9%     65  26.2%
## 3:    TLT  $90.93  $8.61   9.5%     58   5.3%
## 4:    GLD $191.17  $1.83   1.0%    273  52.2%
```
...
![Turtle-style position sizing across multiple assets. Each position is sized so that 2-ATR move equals 1% account risk.](/courses/financial-statistics-1-foundations/../figures/05-2_turtle-sizing-demo-1.png)
...
![Traditional 60/40 portfolios derive most risk from equities. Risk parity equalises risk contributions.](/courses/financial-statistics-1-foundations/../figures/05-2_risk-parity-concept-1.png)
...
![Risk parity weights vary over time as relative volatilities change. Bonds get higher weight due to lower volatility.](/courses/financial-statistics-1-foundations/../figures/05-2_risk-parity-weights-1.png)
...
![Risk parity achieves similar return to 60/40 with lower volatility<U+2014>but relies on leverage for competitive absolute returns.](/courses/financial-statistics-1-foundations/../figures/05-2_risk-parity-performance-1.png)
...
## 1:                 60/40        9.0%    10.2%   0.85   NaN%
## 2:           Risk Parity        7.8%     9.2%   0.82   NaN%
## 3: Risk Parity (Levered)        8.7%    10.2%   0.82   NaN%
```
...
```
##           Asset Volatility Weight Risk Contrib.
##          <char>     <char> <char>        <char>
## 1: SPY (Equity)        18%  20.5%         25.0%
## 2:  TLT (Bonds)        12%  22.6%         25.0%
## 3:   GLD (Gold)        15%  17.6%         25.0%
## 4:   TIP (TIPS)         6%  39.3%         25.0%
```
...
![Risk parity vs equal weight vs market cap weight. Risk parity naturally tilts toward lower-volatility assets.](/courses/financial-statistics-1-foundations/../figures/05-2_risk-parity-comparison-1.png)
