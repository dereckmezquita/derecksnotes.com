...
<Figure src="/courses/financial-statistics-1-foundations/price-vs-returns-1.png" alt="Prices are non-stationary (trending), while returns fluctuate around zero. This is why we model returns, not prices.">
	Prices are non-stationary (trending), while returns fluctuate around zero. This is why we model returns, not prices.
</Figure>
...
<Figure src="/courses/financial-statistics-1-foundations/stylised-facts-summary-1.png" alt="The four stylised facts: no autocorrelation in returns, strong autocorrelation in squared returns, fat tails vs normal, and leverage effect.">
	The four stylised facts: no autocorrelation in returns, strong autocorrelation in squared returns, fat tails vs normal, and leverage effect.
</Figure>
