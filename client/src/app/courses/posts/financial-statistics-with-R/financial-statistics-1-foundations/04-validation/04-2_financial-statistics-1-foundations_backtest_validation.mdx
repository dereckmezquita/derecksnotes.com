...
![Temporal train/test split with embargo period. The embargo prevents information leakage from overlapping signals.](/courses/financial-statistics-1-foundations/../figures/04-2_train-test-split-1.png)
...
![Both train and test sets should contain diverse market regimes (bull, bear, high vol, low vol).](/courses/financial-statistics-1-foundations/../figures/04-2_split-regime-analysis-1.png)
...
```
## Training: 3346 days (2005-01-04 to 2018-04-19)
```
...
```
## Test: 1371 days (2018-07-20 to 2023-12-29)
```
...
![Strategy performance comparison: in-sample (training) vs out-of-sample (test).](/courses/financial-statistics-1-foundations/../figures/04-2_train-test-strategy-example-1.png)
...
![Walk-forward optimisation creates multiple train/test pairs. Each test period uses only past data for training.](/courses/financial-statistics-1-foundations/../figures/04-2_walk-forward-diagram-1.png)
...
```
## Walk 1: Train [2005-01-04 to 2008-01-04], Test [2008-01-07 to 2009-01-05]
##   Params: fast=10, slow=140 | Test Sharpe: NaN
## Walk 2: Train [2005-01-04 to 2009-01-05], Test [2009-01-06 to 2010-01-05]
##   Params: fast=10, slow=70 | Test Sharpe: 2.08
## Walk 3: Train [2005-01-04 to 2010-01-05], Test [2010-01-06 to 2011-01-04]
##   Params: fast=10, slow=80 | Test Sharpe: 0.40
## Walk 4: Train [2005-01-04 to 2011-01-04], Test [2011-01-05 to 2012-01-04]
##   Params: fast=10, slow=80 | Test Sharpe: -1.01
## Walk 5: Train [2005-01-04 to 2012-01-04], Test [2012-01-05 to 2013-01-07]
##   Params: fast=10, slow=70 | Test Sharpe: 0.73
## Walk 6: Train [2005-01-04 to 2013-01-07], Test [2013-01-08 to 2014-01-07]
##   Params: fast=10, slow=70 | Test Sharpe: 1.93
## Walk 7: Train [2005-01-04 to 2014-01-07], Test [2014-01-08 to 2015-01-07]
##   Params: fast=40, slow=150 | Test Sharpe: 1.06
## Walk 8: Train [2005-01-04 to 2015-01-07], Test [2015-01-08 to 2016-01-07]
##   Params: fast=40, slow=150 | Test Sharpe: -3.37
## Walk 9: Train [2005-01-04 to 2016-01-07], Test [2016-01-08 to 2017-01-06]
##   Params: fast=40, slow=150 | Test Sharpe: 1.28
## Walk 10: Train [2005-01-04 to 2017-01-06], Test [2017-01-09 to 2018-01-08]
##   Params: fast=10, slow=80 | Test Sharpe: 3.33
## Walk 11: Train [2005-01-04 to 2018-01-08], Test [2018-01-09 to 2019-01-09]
##   Params: fast=10, slow=80 | Test Sharpe: 0.68
## Walk 12: Train [2005-01-04 to 2019-01-09], Test [2019-01-10 to 2020-01-09]
##   Params: fast=10, slow=80 | Test Sharpe: -0.10
## Walk 13: Train [2005-01-04 to 2020-01-09], Test [2020-01-10 to 2021-01-08]
##   Params: fast=10, slow=80 | Test Sharpe: 2.16
## Walk 14: Train [2005-01-04 to 2021-01-08], Test [2021-01-11 to 2022-01-07]
##   Params: fast=10, slow=80 | Test Sharpe: 0.90
## Walk 15: Train [2005-01-04 to 2022-01-07], Test [2022-01-10 to 2023-01-10]
##   Params: fast=10, slow=80 | Test Sharpe: -0.73
```
...
![Walk-forward test results: out-of-sample Sharpe ratios across different time periods.](/courses/financial-statistics-1-foundations/../figures/04-2_walk-forward-results-1.png)
...
![Combined out-of-sample equity curve from walk-forward testing.](/courses/financial-statistics-1-foundations/../figures/04-2_walk-forward-equity-1.png)
...
![Standard k-fold CV vs time-series CV. Standard CV allows future data to train models predicting the past.](/courses/financial-statistics-1-foundations/../figures/04-2_ts-cv-comparison-1.png)
...
```
##     fold train_n test_n purged_n train_sharpe test_sharpe
##    <int>   <int>  <int>    <num>        <num>       <num>
## 1:     1    1862    358       50   0.09902083  1.52155149
## 2:     2    2220    358       50   0.25917195 -0.02029313
## 3:     3    2578    358       50   0.21980894  0.66355742
## 4:     4    2936    358       50   0.27048638  1.69138876
## 5:     5    3294    358       50   0.39528619  0.29554973
## 6:     6    3652    358       50   0.41012015  1.09972021
## 7:     7    4010    358       50   0.46769533 -0.67301135
## 8:     8    4368    357       50   0.44430648  0.35362441
```
...
![Time-series CV results showing train vs test performance across folds.](/courses/financial-statistics-1-foundations/../figures/04-2_ts-cv-results-plot-1.png)
...
![CPCV generates multiple independent backtest paths. Each path uses a different subset of data for testing.](/courses/financial-statistics-1-foundations/../figures/04-2_cpcv-paths-1.png)
...
```
## Paths with positive Sharpe: 25 (89.3%)
```
...
![CPCV Sharpe distribution shows the range of out-of-sample outcomes across all paths.](/courses/financial-statistics-1-foundations/../figures/04-2_cpcv-distribution-1.png)
