...
<Figure src="/courses/financial-statistics-1-foundations/spread-illustration-1.png" alt="The bid-ask spread represents the immediate cost of trading. Crossing the spread costs half the spread each way.">
	The bid-ask spread represents the immediate cost of trading. Crossing the spread costs half the spread each way.
</Figure>
...
<Figure src="/courses/financial-statistics-1-foundations/spread-by-size-1.png" alt="Spreads vary dramatically by market capitalisation. Small stocks have spreads 10-100x larger than mega-caps.">
	Spreads vary dramatically by market capitalisation. Small stocks have spreads 10-100x larger than mega-caps.
</Figure>
...
```
Turnover Analysis:
  High-turnover strategy: 2.0x annual turnover
  Low-turnover strategy: 85.2x annual turnover

Total Spread Cost (bps) over full period:
   spread_bps high_turnover_cost low_turnover_cost
        <num>              <num>             <num>
1:          1           20.82654               895
2:          5          104.13268              4475
3:         10          208.26536              8950
4:         25          520.66340             22375
5:         50         1041.32680             44750
```
...
<Figure src="/courses/financial-statistics-1-foundations/spread-sensitivity-1.png" alt="Strategy profitability is highly sensitive to spread assumptions. A seemingly profitable strategy can become unprofitable with realistic spreads.">
	Strategy profitability is highly sensitive to spread assumptions. A seemingly profitable strategy can become unprofitable with realistic spreads.
</Figure>
...
<Figure src="/courses/financial-statistics-1-foundations/impact-curve-1.png" alt="Market impact follows a square-root law: impact scales with the square root of order size relative to volume.">
	Market impact follows a square-root law: impact scales with the square root of order size relative to volume.
</Figure>
...
<Figure src="/courses/financial-statistics-1-foundations/impact-by-capacity-1.png" alt="Strategy capacity is limited by market impact. The same strategy generates different Sharpes at different AUM levels.">
	Strategy capacity is limited by market impact. The same strategy generates different Sharpes at different AUM levels.
</Figure>
...
Transaction Cost Breakdown:
   Order ($M) Participation (%) Spread (bps) Impact (bps) Total (bps)
        <num>             <num>        <num>        <num>       <num>
1:        0.1               0.1          1.5          6.3         7.8
2:        0.5               0.5          1.5         14.1        15.6
3:        1.0               1.0          1.5         20.0        21.5
4:        5.0               5.0          1.5         44.7        46.2
5:       10.0              10.0          1.5         63.2        64.7
6:       25.0              25.0          1.5        100.0       101.5
```
...
<Figure src="/courses/financial-statistics-1-foundations/slippage-decomposition-1.png" alt="Implementation shortfall breaks down the gap between paper and actual performance into identifiable components.">
	Implementation shortfall breaks down the gap between paper and actual performance into identifiable components.
</Figure>
...
```
Slippage Impact Analysis ($10M AUM):
  Sharpe (no costs): 0.19
  Sharpe (with slippage): -0.80
  Sharpe reduction: 0.99
  Total slippage: 40953 bps
```
...
<Figure src="/courses/financial-statistics-1-foundations/borrow-cost-distribution-1.png" alt="Borrow costs vary dramatically. Most stocks are cheap to borrow, but a tail of stocks is extremely expensive.">
	Borrow costs vary dramatically. Most stocks are cheap to borrow, but a tail of stocks is extremely expensive.
</Figure>
...
```
Impact of Borrow Costs on Long-Short Strategy:
   Borrow Rate (%) Annual Return (%) Sharpe Ratio
             <num>             <num>        <num>
1:             0.0              3.62         0.19
2:             0.5              3.45         0.18
3:             1.0              3.29         0.17
...
<Figure src="/courses/financial-statistics-1-foundations/borrow-rate-sensitivity-1.png" alt="Borrow costs significantly impact long-short strategies. High borrow rates can destroy profitability.">
	Borrow costs significantly impact long-short strategies. High borrow rates can destroy profitability.
</Figure>
