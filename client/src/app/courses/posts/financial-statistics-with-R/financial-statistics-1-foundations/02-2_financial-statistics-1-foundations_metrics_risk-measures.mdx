...
<Figure src="/courses/financial-statistics-1-foundations/vol-comparison-1.png" alt="High volatility vs low volatility return series. Both have similar cumulative returns, but the paths&lt;U+2014&gt;and the investor experience&lt;U+2014&gt;differ dramatically.">
	High volatility vs low volatility return series. Both have similar cumulative returns, but the paths&lt;U+2014&gt;and the investor experience&lt;U+2014&gt;differ dramatically.
</Figure>
...
<Figure src="/courses/financial-statistics-1-foundations/rolling-vol-1.png" alt="Rolling 60-day volatility of S&amp;P 500 shows distinct regimes: calm periods around 10% and crisis periods exceeding 50%.">
	Rolling 60-day volatility of S&amp;P 500 shows distinct regimes: calm periods around 10% and crisis periods exceeding 50%.
</Figure>
...
```
S&P 500 Volatility Measures:
  Full-sample historical: 19.1%
  Current EWMA (<U+03BB>=0.94): 8.8%
  Current 20-day rolling: 7.3%
```
...
<Figure src="/courses/financial-statistics-1-foundations/vol-measures-comparison-1.png" alt="Comparison of volatility measures: rolling vs EWMA. EWMA reacts more quickly to new information.">
	Comparison of volatility measures: rolling vs EWMA. EWMA reacts more quickly to new information.
</Figure>
...
Volatility Targeting Results:
  Unscaled volatility: 19.1%
  Vol-targeted volatility: 16.1%
  Target: 15.0%
```
...
<Figure src="/courses/financial-statistics-1-foundations/asymmetric-strategies-1.png" alt="Two distributions with identical volatility but different downside profiles. Semi-deviation distinguishes them.">
	Two distributions with identical volatility but different downside profiles. Semi-deviation distinguishes them.
</Figure>
...
Symmetric Returns:
  Volatility: 1.98%
  Semi-deviation (below 0): 1.15%
  Skewness: 0.10

Positively Skewed Returns:
  Volatility: 1.98%
  Semi-deviation (below 0): 0.84%
  Skewness: 0.99
```
...
```
S&P 500 Downside Risk Measures:
  Standard deviation: 19.05%
  Semi-deviation (below 0): 20.60%
  Downside deviation: 13.75%
  LPM(0,1) - Expected shortfall: 0.3637%
  LPM(0,0) - Shortfall probability: 100.00%
```
...
<Figure src="/courses/financial-statistics-1-foundations/drawdown-chart-1.png" alt="S&amp;P 500 cumulative return (top) and underwater chart (bottom). Major drawdowns&lt;U+2014&gt;2008, 2020, 2022&lt;U+2014&gt;are clearly visible.">
	S&amp;P 500 cumulative return (top) and underwater chart (bottom). Major drawdowns&lt;U+2014&gt;2008, 2020, 2022&lt;U+2014&gt;are clearly visible.
</Figure>
...
<Figure src="/courses/financial-statistics-1-foundations/drawdown-duration-1.png" alt="Distribution of drawdown durations. Most drawdowns are short, but some last years.">
	Distribution of drawdown durations. Most drawdowns are short, but some last years.
</Figure>
...
S&P 500 Drawdown Analysis:
  Maximum drawdown: 59.6%
  Average drawdown: 9.8%
  Longest drawdown: 1410 days (5.6 years)
  Time underwater: 89.7%
  CAGR: 8.71%
  Calmar ratio: 0.15
```
...
<Figure src="/courses/financial-statistics-1-foundations/var-distribution-1.png" alt="VaR on the return distribution. VaR marks a specific quantile; it says nothing about losses beyond that point.">
	VaR on the return distribution. VaR marks a specific quantile; it says nothing about losses beyond that point.
</Figure>
...
<Figure src="/courses/financial-statistics-1-foundations/var-exceedances-1.png" alt="VaR exceedances over time. In practice, exceedances cluster during crises&lt;U+2014&gt;violating the i.i.d. assumption.">
	VaR exceedances over time. In practice, exceedances cluster during crises&lt;U+2014&gt;violating the i.i.d. assumption.
</Figure>
...
VaR Exceedance Analysis:
  Expected exceedance rate: 5.0%
  Actual exceedance rate: 5.5%
```
...
```
S&P 500 1-Day 95% VaR:
  Historical: 1.78%
  Parametric (Normal): 1.93%
  Cornish-Fisher: 1.47%
...
Kupiec Test for 95% VaR:
  Observations: 5042
  Exceedances: 278 (expected: 252)
  Exceedance rate: 5.51% (expected: 5.00%)
  LR statistic: 2.71
  p-value: 0.0994
```
...
<Figure src="/courses/financial-statistics-1-foundations/es-visualisation-1.png" alt="Expected Shortfall vs VaR. ES is the average of all losses beyond VaR, capturing tail severity.">
	Expected Shortfall vs VaR. ES is the average of all losses beyond VaR, capturing tail severity.
</Figure>
...
```
S&P 500 95% Expected Shortfall:
  Historical: 2.98%
  Parametric (Normal): 2.43%
  Ratio ES/VaR (hist): 1.67
