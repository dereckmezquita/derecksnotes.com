...
box::use(
    ...
    ./modules/viz[theme_trading, trading_colors, plot_cumulative_returns, plot_drawdown]
)
...
```{r plot-portfolio-results, fig.cap="Portfolio backtest results showing equity curve and drawdowns."}
# Plot equity curve
...
```{r plot-positions, fig.cap="Position evolution over time showing long and short allocations."}
...
```{r plot-monte-carlo, fig.cap="Monte Carlo distribution of Sharpe ratios from random strategies versus observed."}
...
```{r plot-regime-performance, fig.cap="Strategy Sharpe ratio varies significantly across market regimes."}
