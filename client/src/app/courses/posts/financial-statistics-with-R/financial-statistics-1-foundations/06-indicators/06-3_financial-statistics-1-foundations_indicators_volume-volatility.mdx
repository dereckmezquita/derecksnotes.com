...
![On-Balance Volume (OBV) accumulates volume on up days and subtracts on down days. Divergences between OBV and price can signal reversals.](/courses/financial-statistics-1-foundations/../figures/06-3_obv-calculation-1.png)

``` r
print(p2)
```

![On-Balance Volume (OBV) accumulates volume on up days and subtracts on down days. Divergences between OBV and price can signal reversals.](/courses/financial-statistics-1-foundations/../figures/06-3_obv-calculation-2.png)
...
![VWAP (Volume-Weighted Average Price) gives the average price weighted by volume. Institutional traders use it as a benchmark<U+2014>buying below VWAP is considered favourable execution.](/courses/financial-statistics-1-foundations/../figures/06-3_vwap-calculation-1.png)
...
![Money Flow Index (MFI) combines price and volume into an RSI-like oscillator. It identifies overbought/oversold conditions with volume confirmation.](/courses/financial-statistics-1-foundations/../figures/06-3_mfi-calculation-1.png)

``` r
print(p2)
```

![Money Flow Index (MFI) combines price and volume into an RSI-like oscillator. It identifies overbought/oversold conditions with volume confirmation.](/courses/financial-statistics-1-foundations/../figures/06-3_mfi-calculation-2.png)
...
```
## Base strategy: Golden cross (50/200 SMA)
```
...
```
## Filtered: Only when volume > 20-day average
```
...
##                   <char>      <char> <char>         <char>
## 1:            Buy & Hold       12.9%   0.66           100%
## 2:          Golden Cross        8.2%   0.53            78%
## 3: Golden Cross + Volume        4.9%   0.37            33%
```
...
![Volume confirmation filter: only take signals when volume is above its 20-day average. This filters out low-conviction moves.](/courses/financial-statistics-1-foundations/../figures/06-3_volume-confirmation-strategy-1.png)
...
![OBV divergence detection: when price makes new highs but OBV doesn't, the rally lacks conviction and may reverse.](/courses/financial-statistics-1-foundations/../figures/06-3_obv-divergence-1.png)
...
![ATR (Average True Range) captures daily volatility including gaps. Notice how ATR expands during turbulent periods and contracts during calm markets.](/courses/financial-statistics-1-foundations/../figures/06-3_atr-calculation-1.png)

``` r
print(p2)
```

![ATR (Average True Range) captures daily volatility including gaps. Notice how ATR expands during turbulent periods and contracts during calm markets.](/courses/financial-statistics-1-foundations/../figures/06-3_atr-calculation-2.png)
...
![Normalised ATR (ATR/Price) allows comparison across time and assets. A 5 ATR move in 2020 meant the same relative risk as in 2023.](/courses/financial-statistics-1-foundations/../figures/06-3_normalised-atr-1.png)
...
![ATR-based stop placement: stops are set at 2<U+00D7>ATR below entry. This automatically widens stops in volatile markets and tightens them in calm markets.](/courses/financial-statistics-1-foundations/../figures/06-3_atr-stops-1.png)
...
```
## Enter when price moves > 1.5 ATR from previous close
```
...
##                 <char>      <char> <char>       <char>
## 1:          Buy & Hold       11.8%   0.61        33.7%
## 2: Volatility Breakout        0.0%    NaN         0.0%
```
...
![Volatility breakout strategy: enter when price moves more than 1.5<U+00D7>ATR from previous close. Captures explosive moves.](/courses/financial-statistics-1-foundations/../figures/06-3_volatility-breakout-1.png)
...
![Keltner Channels use ATR to create volatility-adjusted bands around an EMA. Unlike Bollinger Bands (which use standard deviation), Keltner Channels capture intraday volatility and gaps.](/courses/financial-statistics-1-foundations/../figures/06-3_keltner-channels-1.png)
...
![Parameter sensitivity surface for RSI strategy. The surface shows Sharpe ratio for different RSI periods and thresholds. Smooth plateaus indicate robust parameters; sharp peaks suggest overfitting.](/courses/financial-statistics-1-foundations/../figures/06-3_parameter-surface-1.png)
...
```
## Robust Parameters (median of top 5):
```
...
![Overfitting demonstration: In-sample performance peaks at complex parameters that fail out-of-sample. Simpler parameters often generalise better.](/courses/financial-statistics-1-foundations/../figures/06-3_overfitting-risk-1.png)
...
```
## === Walk-Forward Optimisation Results ===
```
...
```
##      Train_End Best_Period Best_Oversold IS_Sharpe OOS_Sharpe
##         <Date>       <num>         <num>     <num>      <num>
##  1: 2007-01-03           5            30      1.91       1.42
##  2: 2007-07-03           5            30      1.75       0.32
##  3: 2008-01-03           5            40      1.40      -0.50
##  4: 2008-07-03           5            40      0.49      -0.23
##  5: 2009-01-03          20            25      0.12       0.00
##  6: 2009-07-03          20            25      0.06       0.00
##  7: 2010-01-03          20            25      0.44       0.00
##  8: 2010-07-03          25            30      0.54       0.00
##  9: 2011-01-03          25            30      1.80       0.00
## 10: 2011-07-03           5            25      1.42       0.04
## 11: 2012-01-03          15            40      0.86       0.19
## 12: 2012-07-03          25            30      0.74       0.00
## 13: 2013-01-03          15            30      1.03       0.00
## 14: 2013-07-03          25            30      1.25       0.00
## 15: 2014-01-03          15            30      1.60       0.00
## 16: 2014-07-03          15            40      2.03       2.18
## 17: 2015-01-03          15            35      2.92       0.00
## 18: 2015-07-03          20            40      2.67       0.83
## 19: 2016-01-03          15            35      1.69       2.87
## 20: 2016-07-03          15            35      1.62       2.63
## 21: 2017-01-03          25            40      1.28       0.00
## 22: 2017-07-03          25            40      1.28       0.00
## 23: 2018-01-03          25            40      2.52       1.47
## 24: 2018-07-03           5            35      1.30      -0.65
## 25: 2019-01-03          25            30      0.94       0.00
## 26: 2019-07-03          25            30      1.73       0.00
## 27: 2020-01-03          20            25      1.82       0.00
## 28: 2020-07-03          20            25      1.81       0.00
## 29: 2021-01-03          15            40      0.52       0.00
## 30: 2021-07-03          20            30      0.63       0.00
## 31: 2022-01-03          25            30      0.99       0.00
## 32: 2022-07-03           5            30      0.80      -0.35
## 33: 2023-01-03          20            40      0.54       0.00
## 34: 2023-07-03          10            30      0.74       0.69
## 35: 2024-01-03          15            30      0.73       0.00
## 36: 2024-07-03          10            25      1.30       0.00
## 37: 2025-01-03           5            20      2.31      -0.26
## 38: 2025-07-03          25            30      1.12       0.00
##      Train_End Best_Period Best_Oversold IS_Sharpe OOS_Sharpe
```
...
![Walk-forward optimisation: always test on data the optimiser never saw. This prevents overfitting and gives realistic performance expectations.](/courses/financial-statistics-1-foundations/../figures/06-3_walk-forward-optimisation-1.png)
...
![Parameter stability analysis: track which parameters are selected over time. Stable parameters suggest robust signals; wildly varying parameters suggest noise.](/courses/financial-statistics-1-foundations/../figures/06-3_parameter-stability-1.png)
...
```
## 
## Most frequently selected: Period = 25, Oversold = 30 (8 times)
```
