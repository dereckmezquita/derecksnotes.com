...
![Time-series momentum across different lookback periods. Positive past returns tend to predict positive future returns<U+2014>the momentum effect.](/courses/financial-statistics-1-foundations/../figures/07-1_momentum-existence-1.png)
...
```
## Rule: Long SPY when 12-month trailing return > 0
```
...
## 1:  Buy & Hold        9.7%   0.47        55.2%           100%
## 2: TSMOM (12m)        7.2%   0.51        31.2%            81%
```
...
![Cumulative performance of a simple 12-month momentum strategy. The strategy goes long when trailing 12-month returns are positive, flat otherwise.](/courses/financial-statistics-1-foundations/../figures/07-1_momentum-over-time-1.png)
...
![Return autocorrelation at different lags. Positive autocorrelation at monthly horizons supports the momentum effect; negative autocorrelation at very short horizons suggests microstructure mean-reversion.](/courses/financial-statistics-1-foundations/../figures/07-1_autocorrelation-analysis-1.png)
...
##        <char>      <char> <char> <char>
## 1: Buy & Hold        9.7%   0.47  55.2%
## 2:   TSMOM 1m        4.3%   0.38  38.8%
## 3:   TSMOM 3m        5.2%   0.45  23.7%
## 4:   TSMOM 6m        7.7%   0.63  23.3%
## 5:  TSMOM 12m        7.2%   0.51  31.2%
```
...
![Comparing TSMOM strategies with different lookback periods. The 12-month lookback is standard, but shorter lookbacks react faster to trend changes.](/courses/financial-statistics-1-foundations/../figures/07-1_tsmom-lookbacks-1.png)
...
```
##          asset Ann. Return (B&H) Ann. Return (TSMOM) Sharpe (B&H)
##         <char>            <char>              <char>       <char>
## 1: US Equities             12.8%                7.4%         0.69
## 2:    US Bonds              3.1%                2.3%         0.20
## 3:        Gold              2.5%                0.2%         0.16
## 4:         Oil            -11.2%               -2.8%        -0.32
##    Sharpe (TSMOM) Time in Market
##            <char>         <char>
## 1:           0.50            87%
## 2:           0.19            57%
## 3:           0.02            55%
...
##                <char>      <char> <char>       <char>
## 1:   Equal Weight B&H        1.4%   0.11        33.7%
## 2: Equal Weight TSMOM        1.7%   0.22        15.7%
```
...
![TSMOM applied across multiple assets. The strategy works in equities, bonds, and commodities<U+2014>true diversification benefits.](/courses/financial-statistics-1-foundations/../figures/07-1_tsmom-across-assets-1.png)
...
![Classic golden cross (50/200) on SPY. The fast MA crossing above the slow MA signals trend change. Whipsaws occur when trends reverse quickly.](/courses/financial-statistics-1-foundations/../figures/07-1_ma-crossover-visualisation-1.png)
...
![Whipsaws in ranging markets. When prices oscillate around the MAs, crossover signals generate frequent false signals.](/courses/financial-statistics-1-foundations/../figures/07-1_ma-crossover-whipsaw-1.png)
...
![Sharpe ratio surface for different fast/slow MA combinations. The 50/200 region performs well, but many combinations work similarly.](/courses/financial-statistics-1-foundations/../figures/07-1_optimal-lookback-1.png)
...
##        Strategy Ann. Return Sharpe Max Drawdown Time in Market
##          <char>      <char> <char>       <char>         <char>
## 1:   Buy & Hold       10.0%   0.49        55.2%           100%
## 2: MA Crossover        8.8%   0.62        33.7%            77%
```
...
```
## 
## Total trades: 18 over 18 years (1.0 trades/year)
```
...
![Complete MA crossover strategy with 50/200 parameters. The strategy captures major trends but suffers during ranging periods.](/courses/financial-statistics-1-foundations/../figures/07-1_ma-crossover-strategy-1.png)
...
##              <char>      <char>       <char> <char>       <char>
## 1:        Raw TSMOM        4.8%        19.7%   0.24        43.4%
## 2: Vol-Scaled TSMOM        8.6%        16.3%   0.51        37.4%
```
...
![Raw vs volatility-scaled trend following returns. Vol-scaling reduces extreme returns in both directions, producing more consistent risk-adjusted performance.](/courses/financial-statistics-1-foundations/../figures/07-1_vol-scaling-comparison-1.png)
...
![Volatility scaling through time. Position sizes are reduced during high-volatility periods (like 2008, 2020) and increased during calm periods.](/courses/financial-statistics-1-foundations/../figures/07-1_vol-through-time-1.png)
...
```
## === Volatility-Scaled TSMOM (40% Target Vol) ===
```
...
![Complete volatility-scaled trend following system. The strategy targets 40% volatility (typical for diversified managed futures), sizing each position to contribute equal risk.](/courses/financial-statistics-1-foundations/../figures/07-1_vol-scaling-implementation-1.png)
