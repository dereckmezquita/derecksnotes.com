...
![Trend following applied to multiple asset classes. Each market trends independently; combined, they provide diversification.](/courses/financial-statistics-1-foundations/../figures/07-3_multi-asset-performance-1.png)
...
## 1: Buy & Hold (EW)        1.5%        12.4%   0.12        33.7%
## 2: TSMOM Portfolio        1.1%         5.6%   0.19        17.9%
```
...
![Diversified TSMOM portfolio: equal-weight combination of individual TSMOM signals. Diversification smooths returns substantially.](/courses/financial-statistics-1-foundations/../figures/07-3_portfolio-tsmom-1.png)
...
![Correlation structure of TSMOM returns across assets. Low correlations enable substantial diversification benefits.](/courses/financial-statistics-1-foundations/../figures/07-3_correlation-analysis-1.png)
...
![Complete managed futures system with volatility targeting and position limits. This structure underlies most CTA strategies.](/courses/financial-statistics-1-foundations/../figures/07-3_full-managed-futures-1.png)
...
![Portfolio exposure varies with volatility regime. During high-vol periods, positions are reduced automatically.](/courses/financial-statistics-1-foundations/../figures/07-3_exposure-over-time-1.png)
...
```
##      regime B&H Return TSMOM Return B&H Sharpe TSMOM Sharpe Observations
##      <char>      <num>        <num>      <num>        <num>        <int>
## 1:  Low Vol   15.08097   14.6454027  1.4882714   1.46880662         1685
## 2: High Vol   10.42337    0.2253534  0.4323878   0.01235672         1584
```
...
![TSMOM performance varies by market regime. The strategy struggles during sharp reversals (like March 2020 recovery) but captures sustained trends.](/courses/financial-statistics-1-foundations/../figures/07-3_regime-performance-1.png)
...
```
##    dd_group      Start        End    Max_DD
##       <num>     <Date>     <Date>     <num>
## 1:        0 2011-01-04 2023-12-29 -31.16824
## 2:       NA       <NA>       <NA>        NA
## 3:       NA       <NA>       <NA>        NA
## 4:       NA       <NA>       <NA>        NA
## 5:       NA       <NA>       <NA>        NA
...
![TSMOM drawdown analysis. The largest drawdowns typically occur during sudden trend reversals when the strategy is caught wrong-footed.](/courses/financial-statistics-1-foundations/../figures/07-3_drawdown-analysis-1.png)
...
##             <char>      <char> <char>       <char>
## 1:  Standard TSMOM        7.4%   0.50        31.2%
## 2: Regime-Adaptive        7.1%   0.51        27.8%
```
...
![Regime-adaptive trend following: reduce position size when market appears to be ranging (ADX low). This reduces whipsaw losses.](/courses/financial-statistics-1-foundations/../figures/07-3_regime-adaptive-1.png)
...
##        Strategy Ann. Return Sharpe Max Drawdown
##          <char>      <char> <char>       <char>
## 1:   Pure TSMOM        7.4%   0.50        31.2%
## 2: Regime Blend        8.0%   0.57        28.4%
```
...
![Blending trend following with mean reversion. Using regime signals to allocate between strategies can improve overall performance.](/courses/financial-statistics-1-foundations/../figures/07-3_strategy-blend-1.png)
