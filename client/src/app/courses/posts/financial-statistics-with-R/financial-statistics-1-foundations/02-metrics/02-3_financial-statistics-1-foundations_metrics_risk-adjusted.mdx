...
<Figure src="/courses/financial-statistics-1-foundations/sharpe-iso-1.png" alt="Iso-Sharpe lines in mean-volatility space. Each line represents constant Sharpe ratio; higher is better.">
	Iso-Sharpe lines in mean-volatility space. Each line represents constant Sharpe ratio; higher is better.
</Figure>
...
<Figure src="/courses/financial-statistics-1-foundations/sharpe-uncertainty-1.png" alt="Distribution of estimated Sharpe ratios under sampling uncertainty. The true Sharpe of 1.0 generates widely varying estimates.">
	Distribution of estimated Sharpe ratios under sampling uncertainty. The true Sharpe of 1.0 generates widely varying estimates.
</Figure>
...
```
S&P 500 Sharpe Ratio Analysis:
  Sharpe ratio: 0.53
  Standard error: 0.23
  95% CI: [0.08, 0.99]
  t-statistic: 2.29 (p = 0.0220)
  Based on 21.0 years of data
```
...
Sharpe Ratio Comparison (2000-2009 vs 2010+):
  Period 1 (2000-2009): 0.02 <U+00B1> 0.88
  Period 2 (2010+): 0.77 <U+00B1> 0.56
  Difference: -0.75 <U+00B1> 1.04
  z-statistic: -1.41 (p = 0.1596)
```
...
<Figure src="/courses/financial-statistics-1-foundations/sortino-vs-sharpe-1.png" alt="Strategies with identical Sharpe but different Sortino ratios, reflecting different return asymmetries.">
	Strategies with identical Sharpe but different Sortino ratios, reflecting different return asymmetries.
</Figure>
...
Metrics Comparison:
        Strategy Sharpe Sortino Sortino/Sharpe Skewness
          <char>  <num>   <num>          <num>    <num>
1:     Symmetric   1.27    1.93           1.52     0.03
2: Positive Skew   1.50    2.61           1.74     0.78
3: Negative Skew   1.30    1.61           1.24    -1.51
```
...
<Figure src="/courses/financial-statistics-1-foundations/calmar-analysis-1.png" alt="Calmar ratio decomposition showing the trade-off between returns and maximum drawdown.">
	Calmar ratio decomposition showing the trade-off between returns and maximum drawdown.
</Figure>
...
```
S&P 500 Risk-Adjusted Metrics:
  Sharpe ratio: 0.53
  Sortino ratio: 0.74
  Sortino/Sharpe ratio: 1.39
  Calmar ratio: 0.15
```
...
<Figure src="/courses/financial-statistics-1-foundations/tracking-error-1.png" alt="Active returns (portfolio minus benchmark) over time. Tracking error measures the volatility of this series.">
	Active returns (portfolio minus benchmark) over time. Tracking error measures the volatility of this series.
</Figure>
...
<Figure src="/courses/financial-statistics-1-foundations/ir-distribution-1.png" alt="Distribution of active returns showing positive mean (alpha) and tracking error (standard deviation).">
	Distribution of active returns showing positive mean (alpha) and tracking error (standard deviation).
</Figure>
...
```
Simulated Active Portfolio:
  Information ratio: 0.99
  Active return: 7.76% annualised
  Tracking error: 7.84% annualised

  Portfolio Sharpe: 0.87
...
Active Return Matrix (IR <U+00D7> TE):
            TE = 2%   TE = 4%   TE = 6%   TE = 8%
IR = 0.25   0.5%   1.0%   1.5%   2.0%
IR = 0.50   1.0%   2.0%   3.0%   4.0%
IR = 0.75   1.5%   3.0%   4.5%   6.0%
IR = 1.00   2.0%   4.0%   6.0%   8.0%
```
...
<Figure src="/courses/financial-statistics-1-foundations/alpha-beta-scatter-1.png" alt="Scatter plot of portfolio vs benchmark returns. The slope is beta; the intercept is alpha.">
	Scatter plot of portfolio vs benchmark returns. The slope is beta; the intercept is alpha.
</Figure>
...
<Figure src="/courses/financial-statistics-1-foundations/rolling-beta-1.png" alt="Rolling 252-day beta of S&amp;P 500 (SPY) vs itself is always 1.0. A leveraged fund would show beta &gt; 1.">
	Rolling 252-day beta of S&amp;P 500 (SPY) vs itself is always 1.0. A leveraged fund would show beta &gt; 1.
</Figure>
...
```
Alpha-Beta Analysis:
  Alpha: 4.01% annualised (SE: 1.72%)
  t-statistic: 2.33 (p = 0.0200)

  Beta: 1.206 (SE: 0.006)
  t-statistic: 211.63 (p = 0.0000)

  R-squared: 89.4%
  Residual volatility: 7.90%

  True alpha: 3.00% | Estimated: 4.01%
  True beta: 1.20 | Estimated: 1.21
```
...
Multi-Factor Analysis (Fama-French 3-Factor):
  Alpha: 3.95% (t = 3.78)
  Market beta: 0.10
  SMB beta: 0.50 (t = 73.76)
  HML beta: 0.29 (t = 56.00)
  R-squared: 67.4%
```
