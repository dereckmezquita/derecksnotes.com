...
<Figure src="/references/cheat-sheets_codon-table/codons.png">
    Codons table. See the [amino acids table](/references/cheat-sheets_amino-acids-and-amino-acid-codes) for more information.
</Figure>