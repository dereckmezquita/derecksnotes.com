...
pH is measured on a logarithmic scale, it is measured in units of moles per liter of hydrogen ions often called [hydronium ions](#hydronium-ion) sometimes less precisely called [oxonium ions](#oxonium-ion).
