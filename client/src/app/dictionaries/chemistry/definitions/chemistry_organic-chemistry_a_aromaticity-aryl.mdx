...
<a id="aromaticity-aryl">Aromaticity (aryl)</a> - This is the property of being cyclic (a closed ring), and planar with a ring of resonance bonds. Aromatic chemical groups are called aryl. Requirements for aromaticity, known as Huckel's rule, are as follows:
