...
<a id="kinetic-molecular-theory">Kinetic Molecular Theory</a> - A **conceptual framework** describing **gas behaviour** through **molecular motion**. Assumptions:
...
4. Molecular collisions are frequent, random, and explained by [collision_theory](#collision-theory).

- Ties to the [ideal_gas](#ideal-gas) model.  
