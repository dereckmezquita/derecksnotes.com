...
<a id="alkaline-earth-metal">Alkaline Earth Metal</a> - The elements in **Group 2** of the periodic table: Be, Mg, Ca, Sr, Ba, and Ra. Key traits include:
- Two valence electrons, contributing to their reactivity
- Formation of oxides with the generic formula MO (where M = metal)
- Less reactive than [alkali metals](#alkali-metal), but still form hydroxides and other alkaline compounds
