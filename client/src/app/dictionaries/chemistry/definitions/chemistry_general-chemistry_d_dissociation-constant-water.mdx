...
<a id="dissociation-constant-water">Dissociation Constant (water)</a> - The rate at which water dissociates from its protons. This can be derived from [autoprotolysis](#autoprotolysis).
