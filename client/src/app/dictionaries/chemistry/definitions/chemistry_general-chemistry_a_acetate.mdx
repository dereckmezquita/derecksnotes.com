...
<a id="acetate">Acetate</a> - The conjugate base of acetic acid (CH<sub>3</sub>COOH), represented as CH<sub>3</sub>COO<sup>-</sup>. It arises when an [Arrhenius Acid](#arrhenius-acid) (like acetic acid) donates a proton. Acetates are versatile in chemistry:
