...
<a id="benzene-c6h6">Benzene (C<sub>6</sub>H<sub>6</sub>)</a> - An aromtaic organic molecule of the formula C6H6, molar mass 78.114 g·mol\-1. It is cyclic and contains only Carbon and Hydrogen thus it is called a hydrocarbon.
