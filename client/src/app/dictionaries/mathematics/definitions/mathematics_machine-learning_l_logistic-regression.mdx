...
<Figure src="/dictionaries/mathematics/mathematics_machine-learning_l_logistic-regression-logistic-regression-demo-1.png" alt="Logistic regression predicted probability curve on binary outcome data">
	Logistic regression predicted probability curve on binary outcome data
</Figure>
