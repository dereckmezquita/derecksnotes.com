...
<Figure src="/dictionaries/mathematics/mathematics_geometry_x_x-axis-x-axis-demo-1.png" alt="Coordinate plane highlighting the x-axis with sample points">
	Coordinate plane highlighting the x-axis with sample points
</Figure>
