...
<Figure src="/dictionaries/mathematics/mathematics_finance_c_cointegration-cointegration-demo-1.png" alt="Residuals from a linear combination of two cointegrated time series">
	Residuals from a linear combination of two cointegrated time series
</Figure>
