...
<Figure src="/dictionaries/mathematics/mathematics_machine-learning_l_linear-regression-linear-regression-demo-1.png" alt="Simple linear regression fit with data points and fitted line">
	Simple linear regression fit with data points and fitted line
</Figure>
