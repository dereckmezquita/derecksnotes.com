...
<Figure src="/dictionaries/mathematics/mathematics_trigonometry_u_unit-circle-unit-circle-demo-1.png" alt="Unit circle with a marked angle showing sine and cosine projections">
	Unit circle with a marked angle showing sine and cosine projections
</Figure>
