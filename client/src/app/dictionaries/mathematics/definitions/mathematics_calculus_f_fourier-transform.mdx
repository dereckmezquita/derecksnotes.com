...
<Figure src="/dictionaries/mathematics/mathematics_calculus_f_fourier-transform-fourier-transform-demo-1.png" alt="DFT amplitude spectrum of a composite signal with two sine wave frequencies">
	DFT amplitude spectrum of a composite signal with two sine wave frequencies
</Figure>
