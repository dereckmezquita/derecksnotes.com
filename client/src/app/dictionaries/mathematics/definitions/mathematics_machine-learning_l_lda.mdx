...
<Figure src="/dictionaries/mathematics/mathematics_machine-learning_l_lda-lda-demo-1.png" alt="Linear discriminant analysis projection of three-class data onto the first discriminant axis">
	Linear discriminant analysis projection of three-class data onto the first discriminant axis
</Figure>
