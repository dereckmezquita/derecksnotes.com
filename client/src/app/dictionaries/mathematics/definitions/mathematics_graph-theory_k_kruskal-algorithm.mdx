...
```
## IGRAPH 7286401 UNW- 4 3 -- 
## + attr: name (v/c), weight (e/n)
## + edges from 7286401 (vertex names):
## [1] A--B C--D B--D
```
...
<Figure src="/dictionaries/mathematics/mathematics_graph-theory_k_kruskal-algorithm-unnamed-chunk-1-1.png">
