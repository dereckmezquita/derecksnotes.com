...
<Figure src="/dictionaries/mathematics/mathematics_statistics_k_k-means-k-means-demo-1.png" alt="K-means clustering result on three-cluster synthetic data">
	K-means clustering result on three-cluster synthetic data
</Figure>
