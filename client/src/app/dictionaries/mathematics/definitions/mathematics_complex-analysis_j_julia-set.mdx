...
<Figure src="/dictionaries/mathematics/mathematics_complex-analysis_j_julia-set-julia-set-demo-1.png" alt="Julia set fractal visualisation in the complex plane">
	Julia set fractal visualisation in the complex plane
</Figure>
