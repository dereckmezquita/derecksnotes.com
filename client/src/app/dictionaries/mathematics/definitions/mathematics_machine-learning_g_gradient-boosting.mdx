...
<Figure src="/dictionaries/mathematics/mathematics_machine-learning_g_gradient-boosting-gradient-boosting-demo-1.png" alt="Gradient boosting classification boundary compared with true decision regions">
	Gradient boosting classification boundary compared with true decision regions
</Figure>
