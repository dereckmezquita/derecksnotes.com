...
<Figure src="/dictionaries/mathematics/mathematics_geometry_h_hyperbola-hyperbola-demo-1.png" alt="Parametric plot of a hyperbola with both branches">
	Parametric plot of a hyperbola with both branches
</Figure>
