...
<Figure src="/dictionaries/mathematics/mathematics_machine-learning_n_naive-bayes-naive-bayes-demo-1.png" alt="Naive Bayes classification boundaries on two-dimensional Gaussian data">
	Naive Bayes classification boundaries on two-dimensional Gaussian data
</Figure>
