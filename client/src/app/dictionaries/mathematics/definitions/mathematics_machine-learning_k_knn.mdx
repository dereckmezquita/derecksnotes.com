...
<Figure src="/dictionaries/mathematics/mathematics_machine-learning_k_knn-knn-demo-1.png" alt="K-nearest neighbours classification regions on two-class synthetic data">
	K-nearest neighbours classification regions on two-class synthetic data
</Figure>
