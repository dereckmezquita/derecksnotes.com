...
<Figure src="/dictionaries/mathematics/mathematics_finance_m_monte-carlo-simulation-monte-carlo-simulation-demo-1.png" alt="Monte Carlo simulated stock price paths using geometric Brownian motion">
	Monte Carlo simulated stock price paths using geometric Brownian motion
</Figure>
