...
<Figure src="/dictionaries/mathematics/mathematics_finance_a_algorithmic-trading-algorithmic-trading-demo-1.png" alt="Simulated moving average crossover trading strategy on random walk price data">
	Simulated moving average crossover trading strategy on random walk price data
</Figure>

```
##      day          ret signal          pnl      cumPNL
##    <int>        <num>  <num>        <num>       <num>
## 1:   195 -0.012608015     -1  0.012608015 -0.02829493
## 2:   196  0.020472134     -1 -0.020472134 -0.04876707
## 3:   197  0.006507088      1  0.006507088 -0.04225998
## 4:   198 -0.012012714      1 -0.012012714 -0.05427269
## 5:   199 -0.005611659     -1  0.005611659 -0.04866103
## 6:   200 -0.011354801     -1  0.011354801 -0.03730623
```
