...
<Figure src="/dictionaries/mathematics/mathematics_statistics_p_poisson-distribution-poisson-distribution-demo-1.png" alt="Poisson probability mass function for lambda values 1, 4, and 10">
	Poisson probability mass function for lambda values 1, 4, and 10
</Figure>
