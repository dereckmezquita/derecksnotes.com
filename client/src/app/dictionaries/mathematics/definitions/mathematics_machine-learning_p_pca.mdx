...
<Figure src="/dictionaries/mathematics/mathematics_machine-learning_p_pca-pca-demo-1.png" alt="PCA scores plot of correlated two-dimensional synthetic data">
	PCA scores plot of correlated two-dimensional synthetic data
</Figure>
