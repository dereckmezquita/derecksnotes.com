...
<Figure src="/dictionaries/mathematics/mathematics_machine-learning_n_neural-network-neural-network-demo-1.png" alt="Single hidden layer neural network classification boundary">
	Single hidden layer neural network classification boundary
</Figure>
