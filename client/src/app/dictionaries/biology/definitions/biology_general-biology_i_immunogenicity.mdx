...
- The physical and chemical characteristics of the [antigen](#antigen):  
   - Its size it must contain at least two [epitopes](#epitope-antigenic-determinant) in order to be fixed by an [antibody](#antibody).  
   - Its form if it is a particle or not.  
   - Its rigidity in order to be [complementary](#complementary) to other [paratopes](#paratope-antigen-binding-site).
