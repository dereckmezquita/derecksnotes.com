...
<a id="melting-temperature">Melting Temperature</a> - Melting temperature is referring the the dehybridisation temperature of [DNA](#dna-desoxyribonucleic-acid) primers (most often). For calculating these temperatures, which are to be used when designating a [PCR](#polymerase-chain-reaction-pcr) protocol, the following formulas are to be used:
