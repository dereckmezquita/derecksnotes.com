...
export function SideBarAbout(): ReactElement {
  return (
    <SideBarAboutContainer>
      ...
      <p>
        This website is custom made by Dereck using React, Next.js 15 app dir,
        and TypeScript. It incorporates progressive web app technologies and
        relies on a Bun backend along with a SQLite database and Docker for
        CI/CD deployment.
      </p>
      <p>
        If you would like to know more you can find the full source code on{' '}
