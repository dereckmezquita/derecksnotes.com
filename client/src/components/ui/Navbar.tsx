    ...
    <NavContainer>
      ...
      <ResponsiveMenu open={isMenuOpen}>
        ...
        <DropDownContainer>
          ...
          <DropDownContent>
            <NavLeftItem onClick={closeMenu} href="/dictionaries/biology">
              Biology Dictionary
            </NavLeftItem>
            <NavLeftItem onClick={closeMenu} href="/dictionaries/chemistry">
              Chemistry Dictionary
            </NavLeftItem>
            <NavLeftItem onClick={closeMenu} href="/dictionaries/mathematics">
